...
80100048:	bb d4 bf 10 80       	mov    $0x8010bfd4,%ebx
{
8010004d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&bcache.lock, "bcache");
80100050:	68 80 74 10 80       	push   $0x80107480
80100055:	68 a0 bf 10 80       	push   $0x8010bfa0
8010005a:	e8 b1 44 00 00       	call   80104510 <initlock>
  bcache.head.next = &bcache.head;
8010005f:	83 c4 10             	add    $0x10,%esp
80100062:	b8 9c 06 11 80       	mov    $0x8011069c,%eax
  bcache.head.prev = &bcache.head;
80100067:	c7 05 ec 06 11 80 9c 	movl   $0x8011069c,0x801106ec
8010006e:	06 11 80 
  bcache.head.next = &bcache.head;
80100071:	c7 05 f0 06 11 80 9c 	movl   $0x8011069c,0x801106f0
80100078:	06 11 80 
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
...
801000b0:	89 1d f0 06 11 80    	mov    %ebx,0x801106f0
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	81 fb 40 04 11 80    	cmp    $0x80110440,%ebx
...
801000e0:	8b 75 0c             	mov    0xc(%ebp),%esi
  acquire(&bcache.lock);
801000e3:	68 a0 bf 10 80       	push   $0x8010bfa0
801000e8:	e8 a3 45 00 00       	call   80104690 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000ed:	8b 1d f0 06 11 80    	mov    0x801106f0,%ebx
801000f3:	83 c4 10             	add    $0x10,%esp
801000f6:	81 fb 9c 06 11 80    	cmp    $0x8011069c,%ebx
...
80100213:	e8 58 42 00 00       	call   80104470 <releasesleep>
  ...
  acquire(&bcache.lock);
80100218:	c7 04 24 a0 bf 10 80 	movl   $0x8010bfa0,(%esp)
...
80100243:	89 50 54             	mov    %edx,0x54(%eax)
    b->next = bcache.head.next;
80100246:	a1 f0 06 11 80       	mov    0x801106f0,%eax
    b->prev = &bcache.head;
8010024b:	c7 43 50 9c 06 11 80 	movl   $0x8011069c,0x50(%ebx)
    b->next = bcache.head.next;
80100252:	89 43 54             	mov    %eax,0x54(%ebx)
    bcache.head.next->prev = b;
80100255:	a1 f0 06 11 80       	mov    0x801106f0,%eax
8010025a:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
8010025d:	89 1d f0 06 11 80    	mov    %ebx,0x801106f0
  }
  
  release(&bcache.lock);
80100263:	c7 45 08 a0 bf 10 80 	movl   $0x8010bfa0,0x8(%ebp)
}
...
801002c6:	a1 80 09 11 80       	mov    0x80110980,%eax
801002cb:	3b 05 84 09 11 80    	cmp    0x80110984,%eax
...
801002e0:	68 80 09 11 80       	push   $0x80110980
801002e5:	e8 c6 3c 00 00       	call   80103fb0 <sleep>
    while(input.r == input.w){
801002ea:	a1 80 09 11 80       	mov    0x80110980,%eax
801002ef:	83 c4 10             	add    $0x10,%esp
801002f2:	3b 05 84 09 11 80    	cmp    0x80110984,%eax
...
80100333:	89 15 80 09 11 80    	mov    %edx,0x80110980
80100339:	89 c2                	mov    %eax,%edx
8010033b:	83 e2 7f             	and    $0x7f,%edx
8010033e:	0f be 8a 00 09 11 80 	movsbl -0x7feef700(%edx),%ecx
    if(c == C('D')){  // EOF
...
80100384:	73 d7                	jae    8010035d <consoleread+0xcd>
        input.r--;
80100386:	a3 80 09 11 80       	mov    %eax,0x80110980
...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 df 7d 10 80 	movl   $0x80107ddf,(%esp)
...
80100515:	e8 76 59 00 00       	call   80105e90 <uartputc>
8010051a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100521:	e8 6a 59 00 00       	call   80105e90 <uartputc>
80100526:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052d:	e8 5e 59 00 00       	call   80105e90 <uartputc>
...
801008b4:	a1 88 09 11 80       	mov    0x80110988,%eax
801008b9:	89 c2                	mov    %eax,%edx
801008bb:	2b 15 80 09 11 80    	sub    0x80110980,%edx
...
801008d2:	89 0d 88 09 11 80    	mov    %ecx,0x80110988
        c = (c == '\r') ? '\n' : c;
801008d8:	83 fb 0d             	cmp    $0xd,%ebx
801008db:	0f 84 02 01 00 00    	je     801009e3 <consoleintr+0x183>
        input.buf[input.e++ % INPUT_BUF] = c;
801008e1:	88 98 00 09 11 80    	mov    %bl,-0x7feef700(%eax)
  if(panicked){
...
80100908:	a1 80 09 11 80       	mov    0x80110980,%eax
8010090d:	83 e8 80             	sub    $0xffffff80,%eax
80100910:	39 05 88 09 11 80    	cmp    %eax,0x80110988
80100916:	75 80                	jne    80100898 <consoleintr+0x38>
80100918:	e9 f6 00 00 00       	jmp    80100a13 <consoleintr+0x1b3>
8010091d:	8d 76 00             	lea    0x0(%esi),%esi
      while(input.e != input.w &&
80100920:	a1 88 09 11 80       	mov    0x80110988,%eax
80100925:	39 05 84 09 11 80    	cmp    %eax,0x80110984
...
80100936:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100939:	80 ba 00 09 11 80 0a 	cmpb   $0xa,-0x7feef700(%edx)
80100940:	0f 84 52 ff ff ff    	je     80100898 <consoleintr+0x38>
  if(panicked){
80100946:	8b 15 58 a5 10 80    	mov    0x8010a558,%edx
        input.e--;
8010094c:	a3 88 09 11 80       	mov    %eax,0x80110988
  if(panicked){
...
80100965:	e8 a6 fa ff ff       	call   80100410 <consputc.part.0>
      while(input.e != input.w &&
8010096a:	a1 88 09 11 80       	mov    0x80110988,%eax
8010096f:	3b 05 84 09 11 80    	cmp    0x80110984,%eax
80100975:	75 ba                	jne    80100931 <consoleintr+0xd1>
80100977:	e9 1c ff ff ff       	jmp    80100898 <consoleintr+0x38>
8010097c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(input.e != input.w){
80100980:	a1 88 09 11 80       	mov    0x80110988,%eax
80100985:	3b 05 84 09 11 80    	cmp    0x80110984,%eax
8010098b:	0f 84 07 ff ff ff    	je     80100898 <consoleintr+0x38>
        input.e--;
80100991:	83 e8 01             	sub    $0x1,%eax
80100994:	a3 88 09 11 80       	mov    %eax,0x80110988
  if(panicked){
...
801009e2:	c3                   	ret    
        input.buf[input.e++ % INPUT_BUF] = c;
801009e3:	c6 80 00 09 11 80 0a 	movb   $0xa,-0x7feef700(%eax)
  if(panicked){
...
801009ff:	e9 7c 38 00 00       	jmp    80104280 <procdump>
80100a04:	b8 0a 00 00 00       	mov    $0xa,%eax
80100a09:	e8 02 fa ff ff       	call   80100410 <consputc.part.0>
        if(c == '\n' || c == C('D') || input.e == input.r+INPUT_BUF){
80100a0e:	a1 88 09 11 80       	mov    0x80110988,%eax
          wakeup(&input.r);
80100a13:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
80100a16:	a3 84 09 11 80       	mov    %eax,0x80110984
          wakeup(&input.r);
80100a1b:	68 80 09 11 80       	push   $0x80110980
80100a20:	e8 5b 37 00 00       	call   80104180 <wakeup>
...
80100a4d:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
80100a4f:	c7 05 4c 13 11 80 40 	movl   $0x80100640,0x8011134c
80100a56:	06 10 80 
  devsw[CONSOLE].read = consoleread;
80100a59:	c7 05 48 13 11 80 90 	movl   $0x80100290,0x80111348
80100a60:	02 10 80 
  cons.locking = 1;
...
80100b0a:	75 ce                	jne    80100ada <exec+0x5a>
  if((pgdir = setupkvm()) == 0)
80100b0c:	e8 ef 64 00 00       	call   80107000 <setupkvm>
...
80100b73:	e8 a8 62 00 00       	call   80106e20 <allocuvm>
...
80100ba9:	e8 a2 61 00 00       	call   80106d50 <loaduvm>
...
80100beb:	e8 90 63 00 00       	call   80106f80 <freevm>
  if(ip){
...
80100c32:	e8 e9 61 00 00       	call   80106e20 <allocuvm>
...
80100c51:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c53:	e8 48 64 00 00       	call   801070a0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100ce1:	e8 9a 62 00 00       	call   80106f80 <freevm>
...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 c8 64 00 00       	call   80107200 <copyout>
...
80100d9d:	e8 1e 5e 00 00       	call   80106bc0 <switchuvm>
  freevm(oldpgdir);
80100da2:	89 3c 24             	mov    %edi,(%esp)
80100da5:	e8 d6 61 00 00       	call   80106f80 <freevm>
  return 0;
...
80100def:	68 a0 09 11 80       	push   $0x801109a0
...
80100e08:	bb d4 09 11 80       	mov    $0x801109d4,%ebx
{
80100e0d:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100e10:	68 a0 09 11 80       	push   $0x801109a0
...
80100e23:	81 fb 34 13 11 80    	cmp    $0x80111334,%ebx
...
80100e53:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100e55:	68 a0 09 11 80       	push   $0x801109a0
...
80100e7b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100e7e:	68 a0 09 11 80       	push   $0x801109a0
...
80100e98:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e9b:	68 a0 09 11 80       	push   $0x801109a0
...
80100ecd:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100ed0:	68 a0 09 11 80       	push   $0x801109a0
...
80100f05:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100f08:	68 a0 09 11 80       	push   $0x801109a0
  ff = *f;
...
80100f2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&ftable.lock);
80100f30:	c7 45 08 a0 09 11 80 	movl   $0x801109a0,0x8(%ebp)
}
...
801011b8:	03 05 b8 13 11 80    	add    0x801113b8,%eax
{
...
80101239:	8b 0d a0 13 11 80    	mov    0x801113a0,%ecx
{
...
8010125c:	03 05 b8 13 11 80    	add    0x801113b8,%eax
...
80101271:	a1 a0 13 11 80       	mov    0x801113a0,%eax
...
801012c9:	39 05 a0 13 11 80    	cmp    %eax,0x801113a0
...
8010134a:	bb f4 13 11 80       	mov    $0x801113f4,%ebx
{
8010134f:	83 ec 28             	sub    $0x28,%esp
80101352:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101355:	68 c0 13 11 80       	push   $0x801113c0
...
80101374:	81 c3 90 00 00 00    	add    $0x90,%ebx
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010137a:	81 fb 14 30 11 80    	cmp    $0x80113014,%ebx
...
80101399:	89 c6                	mov    %eax,%esi
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010139b:	81 fb 14 30 11 80    	cmp    $0x80113014,%ebx
...
801013bb:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
801013c2:	68 c0 13 11 80       	push   $0x801113c0
...
801013eb:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801013ed:	68 c0 13 11 80       	push   $0x801113c0
      ip->ref++;
...
80101406:	c3                   	ret    
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101407:	81 fb 14 30 11 80    	cmp    $0x80113014,%ebx
...
80101548:	bb 00 14 11 80       	mov    $0x80111400,%ebx
8010154d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
80101550:	68 8b 75 10 80       	push   $0x8010758b
80101555:	68 c0 13 11 80       	push   $0x801113c0
...
8010157f:	81 fb 20 30 11 80    	cmp    $0x80113020,%ebx
80101585:	75 e1                	jne    80101568 <iinit+0x28>
  readsb(dev, &sb);
80101587:	83 ec 08             	sub    $0x8,%esp
8010158a:	68 a0 13 11 80       	push   $0x801113a0
8010158f:	ff 75 08             	pushl  0x8(%ebp)
80101592:	e8 69 ff ff ff       	call   80101500 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
80101597:	ff 35 b8 13 11 80    	pushl  0x801113b8
8010159d:	ff 35 b4 13 11 80    	pushl  0x801113b4
801015a3:	ff 35 b0 13 11 80    	pushl  0x801113b0
801015a9:	ff 35 ac 13 11 80    	pushl  0x801113ac
801015af:	ff 35 a8 13 11 80    	pushl  0x801113a8
801015b5:	ff 35 a4 13 11 80    	pushl  0x801113a4
801015bb:	ff 35 a0 13 11 80    	pushl  0x801113a0
...
801015f0:	83 3d a8 13 11 80 01 	cmpl   $0x1,0x801113a8
{
...
8010161f:	3b 3d a8 13 11 80    	cmp    0x801113a8,%edi
80101625:	73 69                	jae    80101690 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101627:	89 f8                	mov    %edi,%eax
80101629:	83 ec 08             	sub    $0x8,%esp
8010162c:	c1 e8 03             	shr    $0x3,%eax
8010162f:	03 05 b4 13 11 80    	add    0x801113b4,%eax
...
801016b8:	03 05 b4 13 11 80    	add    0x801113b4,%eax
...
8010173b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010173e:	68 c0 13 11 80       	push   $0x801113c0
80101743:	e8 48 2f 00 00       	call   80104690 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 c0 13 11 80 	movl   $0x801113c0,(%esp)
...
801017a9:	03 05 b4 13 11 80    	add    0x801113b4,%eax
...
801018be:	e8 ad 2b 00 00       	call   80104470 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 c0 13 11 80 	movl   $0x801113c0,(%esp)
801018ca:	e8 c1 2d 00 00       	call   80104690 <acquire>
  ip->ref--;
801018cf:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801018d3:	83 c4 10             	add    $0x10,%esp
801018d6:	c7 45 08 c0 13 11 80 	movl   $0x801113c0,0x8(%ebp)
}
...
801018f3:	68 c0 13 11 80       	push   $0x801113c0
801018f8:	e8 93 2d 00 00       	call   80104690 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 c0 13 11 80 	movl   $0x801113c0,(%esp)
...
80101b3a:	8b 04 c5 40 13 11 80 	mov    -0x7feeecc0(,%eax,8),%eax
...
80101c4a:	8b 04 c5 44 13 11 80 	mov    -0x7feeecbc(,%eax,8),%eax
...
80101d94:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101d97:	68 c0 13 11 80       	push   $0x801113c0
80101d9c:	e8 ef 28 00 00       	call   80104690 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 c0 13 11 80 	movl   $0x801113c0,(%esp)
...
80102020:	68 c6 7b 10 80       	push   $0x80107bc6
...
80102169:	58                   	pop    %eax
8010216a:	a1 e0 36 11 80       	mov    0x801136e0,%eax
8010216f:	5a                   	pop    %edx
...
8010224d:	e8 2e 1f 00 00       	call   80104180 <wakeup>
...
80102385:	c7 05 14 30 11 80 00 	movl   $0xfec00000,0x80113014
8010238c:	00 c0 fe 
{
...
8010239a:	00 00 00 
  return ioapic->data;
8010239d:	8b 15 14 30 11 80    	mov    0x80113014,%edx
801023a3:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801023a6:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801023ac:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
801023b2:	0f b6 15 40 31 11 80 	movzbl 0x80113140,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
801023d8:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
...
801023f2:	89 c3                	mov    %eax,%ebx
  ioapic->data = data;
801023f4:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
...
8010240c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010240e:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
...
80102434:	55                   	push   %ebp
  ioapic->reg = reg;
80102435:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
{
...
80102447:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102449:	8b 0d 14 30 11 80    	mov    0x80113014,%ecx
...
80102458:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
8010245a:	a1 14 30 11 80       	mov    0x80113014,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102486:	81 fb 88 60 11 80    	cmp    $0x80116088,%ebx
...
801024a6:	e8 f5 22 00 00       	call   801047a0 <memset>
  ...
  if(kmem.use_lock)
801024ab:	8b 15 54 30 11 80    	mov    0x80113054,%edx
...
801024b8:	a1 58 30 11 80       	mov    0x80113058,%eax
801024bd:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
801024bf:	a1 54 30 11 80       	mov    0x80113054,%eax
  kmem.freelist = r;
801024c4:	89 1d 58 30 11 80    	mov    %ebx,0x80113058
  if(kmem.use_lock)
...
801024db:	68 20 30 11 80       	push   $0x80113020
801024e0:	e8 ab 21 00 00       	call   80104690 <acquire>
801024e5:	83 c4 10             	add    $0x10,%esp
801024e8:	eb ce                	jmp    801024b8 <kfree+0x48>
801024ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
801024f0:	c7 45 08 20 30 11 80 	movl   $0x80113020,0x8(%ebp)
}
...
80102574:	68 20 30 11 80       	push   $0x80113020
...
80102581:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102584:	c7 05 54 30 11 80 00 	movl   $0x0,0x80113054
8010258b:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
80102612:	73 e4                	jae    801025f8 <kinit2+0x28>
  kmem.use_lock = 1;
80102614:	c7 05 54 30 11 80 01 	movl   $0x1,0x80113054
8010261b:	00 00 00 
}
...
80102630:	f3 0f 1e fb          	endbr32 
  ...
  if(kmem.use_lock)
80102634:	a1 54 30 11 80       	mov    0x80113054,%eax
80102639:	85 c0                	test   %eax,%eax
8010263b:	75 1b                	jne    80102658 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
8010263d:	a1 58 30 11 80       	mov    0x80113058,%eax
  if(r)
80102642:	85 c0                	test   %eax,%eax
80102644:	74 0a                	je     80102650 <kalloc+0x20>
    kmem.freelist = r->next;
80102646:	8b 10                	mov    (%eax),%edx
80102648:	89 15 58 30 11 80    	mov    %edx,0x80113058
  if(kmem.use_lock)
8010264e:	c3                   	ret    
8010264f:	90                   	nop
    release(&kmem.lock);
...
8010265b:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
8010265e:	68 20 30 11 80       	push   $0x80113020
80102663:	e8 28 20 00 00       	call   80104690 <acquire>
  r = kmem.freelist;
80102668:	a1 58 30 11 80       	mov    0x80113058,%eax
  if(r)
8010266d:	8b 15 54 30 11 80    	mov    0x80113054,%edx
80102673:	83 c4 10             	add    $0x10,%esp
80102676:	85 c0                	test   %eax,%eax
80102678:	74 08                	je     80102682 <kalloc+0x52>
    kmem.freelist = r->next;
8010267a:	8b 08                	mov    (%eax),%ecx
8010267c:	89 0d 58 30 11 80    	mov    %ecx,0x80113058
  if(kmem.use_lock)
...
8010268c:	68 20 30 11 80       	push   $0x80113020
...
801027a0:	f3 0f 1e fb          	endbr32 
  if(!lapic)
801027a4:	a1 5c 30 11 80       	mov    0x8011305c,%eax
...
801028a0:	f3 0f 1e fb          	endbr32 
  if (!lapic)
801028a4:	a1 5c 30 11 80       	mov    0x8011305c,%eax
...
801028c0:	f3 0f 1e fb          	endbr32 
  if(lapic)
801028c4:	a1 5c 30 11 80       	mov    0x8011305c,%eax
...
8010292c:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
80102932:	a1 5c 30 11 80       	mov    0x8011305c,%eax
...
80102b90:	8b 0d a8 30 11 80    	mov    0x801130a8,%ecx
...
80102bb0:	a1 94 30 11 80       	mov    0x80113094,%eax
80102bb5:	83 ec 08             	sub    $0x8,%esp
80102bb8:	01 f8                	add    %edi,%eax
80102bba:	83 c0 01             	add    $0x1,%eax
80102bbd:	50                   	push   %eax
80102bbe:	ff 35 a4 30 11 80    	pushl  0x801130a4
80102bc4:	e8 07 d5 ff ff       	call   801000d0 <bread>
80102bc9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102bcb:	58                   	pop    %eax
80102bcc:	5a                   	pop    %edx
80102bcd:	ff 34 bd ac 30 11 80 	pushl  -0x7feecf54(,%edi,4)
80102bd4:	ff 35 a4 30 11 80    	pushl  0x801130a4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102c14:	39 3d a8 30 11 80    	cmp    %edi,0x801130a8
...
80102c37:	ff 35 94 30 11 80    	pushl  0x80113094
80102c3d:	ff 35 a4 30 11 80    	pushl  0x801130a4
...
80102c4b:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102c4d:	a1 a8 30 11 80       	mov    0x801130a8,%eax
...
80102c60:	8b 0c 95 ac 30 11 80 	mov    -0x7feecf54(,%edx,4),%ecx
...
80102ca3:	68 60 30 11 80       	push   $0x80113060
...
80102cbc:	59                   	pop    %ecx
  log.dev = dev;
80102cbd:	89 1d a4 30 11 80    	mov    %ebx,0x801130a4
  log.size = sb.nlog;
80102cc3:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102cc6:	a3 94 30 11 80       	mov    %eax,0x80113094
  log.size = sb.nlog;
80102ccb:	89 15 98 30 11 80    	mov    %edx,0x80113098
  struct buf *buf = bread(log.dev, log.start);
80102cd1:	5a                   	pop    %edx
...
80102cdf:	89 0d a8 30 11 80    	mov    %ecx,0x801130a8
  for (i = 0; i < log.lh.n; i++) {
...
80102cf4:	89 1c 95 ac 30 11 80 	mov    %ebx,-0x7feecf54(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102d0b:	e8 80 fe ff ff       	call   80102b90 <install_trans>
  log.lh.n = 0;
80102d10:	c7 05 a8 30 11 80 00 	movl   $0x0,0x801130a8
80102d17:	00 00 00 
...
80102d37:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102d3a:	68 60 30 11 80       	push   $0x80113060
...
80102d53:	68 60 30 11 80       	push   $0x80113060
80102d58:	68 60 30 11 80       	push   $0x80113060
80102d5d:	e8 4e 12 00 00       	call   80103fb0 <sleep>
80102d62:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102d65:	a1 a0 30 11 80       	mov    0x801130a0,%eax
80102d6a:	85 c0                	test   %eax,%eax
80102d6c:	75 e2                	jne    80102d50 <begin_op+0x20>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102d6e:	a1 9c 30 11 80       	mov    0x8011309c,%eax
...
80102d87:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102d8a:	a3 9c 30 11 80       	mov    %eax,0x8011309c
      release(&log.lock);
80102d8f:	68 60 30 11 80       	push   $0x80113060
...
80102daa:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102dad:	68 60 30 11 80       	push   $0x80113060
80102db2:	e8 d9 18 00 00       	call   80104690 <acquire>
  log.outstanding -= 1;
80102db7:	a1 9c 30 11 80       	mov    0x8011309c,%eax
  if(log.committing)
80102dbc:	8b 35 a0 30 11 80    	mov    0x801130a0,%esi
80102dc2:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102dc5:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102dc8:	89 1d 9c 30 11 80    	mov    %ebx,0x8011309c
  if(log.committing)
...
80102dd8:	0f 85 f2 00 00 00    	jne    80102ed0 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102dde:	c7 05 a0 30 11 80 01 	movl   $0x1,0x801130a0
80102de5:	00 00 00 
...
80102deb:	68 60 30 11 80       	push   $0x80113060
...
{
  if (log.lh.n > 0) {
80102df5:	8b 0d a8 30 11 80    	mov    0x801130a8,%ecx
80102dfb:	83 c4 10             	add    $0x10,%esp
80102dfe:	85 c9                	test   %ecx,%ecx
80102e00:	7f 3e                	jg     80102e40 <end_op+0xa0>
    acquire(&log.lock);
80102e02:	83 ec 0c             	sub    $0xc,%esp
80102e05:	68 60 30 11 80       	push   $0x80113060
80102e0a:	e8 81 18 00 00       	call   80104690 <acquire>
    wakeup(&log);
80102e0f:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
    log.committing = 0;
80102e16:	c7 05 a0 30 11 80 00 	movl   $0x0,0x801130a0
80102e1d:	00 00 00 
    wakeup(&log);
80102e20:	e8 5b 13 00 00       	call   80104180 <wakeup>
    release(&log.lock);
80102e25:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
...
80102e40:	a1 94 30 11 80       	mov    0x80113094,%eax
80102e45:	83 ec 08             	sub    $0x8,%esp
80102e48:	01 d8                	add    %ebx,%eax
80102e4a:	83 c0 01             	add    $0x1,%eax
80102e4d:	50                   	push   %eax
80102e4e:	ff 35 a4 30 11 80    	pushl  0x801130a4
80102e54:	e8 77 d2 ff ff       	call   801000d0 <bread>
80102e59:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102e5b:	58                   	pop    %eax
80102e5c:	5a                   	pop    %edx
80102e5d:	ff 34 9d ac 30 11 80 	pushl  -0x7feecf54(,%ebx,4)
80102e64:	ff 35 a4 30 11 80    	pushl  0x801130a4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102ea4:	3b 1d a8 30 11 80    	cmp    0x801130a8,%ebx
...
80102eb1:	e8 da fc ff ff       	call   80102b90 <install_trans>
    log.lh.n = 0;
80102eb6:	c7 05 a8 30 11 80 00 	movl   $0x0,0x801130a8
80102ebd:	00 00 00 
...
80102ed3:	68 60 30 11 80       	push   $0x80113060
80102ed8:	e8 a3 12 00 00       	call   80104180 <wakeup>
  release(&log.lock);
80102edd:	c7 04 24 60 30 11 80 	movl   $0x80113060,(%esp)
...
80102f1b:	8b 15 a8 30 11 80    	mov    0x801130a8,%edx
{
80102f21:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102f24:	83 fa 1d             	cmp    $0x1d,%edx
80102f27:	0f 8f 91 00 00 00    	jg     80102fbe <log_write+0xae>
80102f2d:	a1 98 30 11 80       	mov    0x80113098,%eax
80102f32:	83 e8 01             	sub    $0x1,%eax
80102f35:	39 c2                	cmp    %eax,%edx
80102f37:	0f 8d 81 00 00 00    	jge    80102fbe <log_write+0xae>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102f3d:	a1 9c 30 11 80       	mov    0x8011309c,%eax
...
80102f4d:	68 60 30 11 80       	push   $0x80113060
80102f52:	e8 39 17 00 00       	call   80104690 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102f57:	8b 15 a8 30 11 80    	mov    0x801130a8,%edx
...
80102f75:	74 29                	je     80102fa0 <log_write+0x90>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102f77:	39 0c 85 ac 30 11 80 	cmp    %ecx,-0x7feecf54(,%eax,4)
80102f7e:	75 f0                	jne    80102f70 <log_write+0x60>
      break;
  }
  log.lh.block[i] = b->blockno;
80102f80:	89 0c 85 ac 30 11 80 	mov    %ecx,-0x7feecf54(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
...
80102f8a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
80102f8d:	c7 45 08 60 30 11 80 	movl   $0x80113060,0x8(%ebp)
}
80102f94:	c9                   	leave  
  release(&log.lock);
...
80102f9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102fa0:	89 0c 95 ac 30 11 80 	mov    %ecx,-0x7feecf54(,%edx,4)
    log.lh.n++;
80102fa7:	83 c2 01             	add    $0x1,%edx
80102faa:	89 15 a8 30 11 80    	mov    %edx,0x801130a8
80102fb0:	eb d5                	jmp    80102f87 <log_write+0x77>
  log.lh.block[i] = b->blockno;
80102fb2:	8b 43 08             	mov    0x8(%ebx),%eax
80102fb5:	a3 ac 30 11 80       	mov    %eax,0x801130ac
  if (i == log.lh.n)
...
80103002:	e8 c9 2a 00 00       	call   80105ad0 <idtinit>
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 71 3b 00 00       	call   80106ba0 <switchkvm>
  seginit();
8010302f:	e8 dc 3a 00 00       	call   80106b10 <seginit>
  lapicinit();
...
8010305b:	68 88 60 11 80       	push   $0x80116088
80103060:	e8 fb f4 ff ff       	call   80102560 <kinit1>
  kvmalloc();      // kernel page table
80103065:	e8 16 40 00 00       	call   80107080 <kvmalloc>
  mpinit();        // detect other processors
8010306a:	e8 81 01 00 00       	call   801031f0 <mpinit>
  lapicinit();     // interrupt controller
8010306f:	e8 2c f7 ff ff       	call   801027a0 <lapicinit>
  seginit();       // segment descriptors
80103074:	e8 97 3a 00 00       	call   80106b10 <seginit>
  picinit();       // disable pic
...
80103088:	e8 43 2d 00 00       	call   80105dd0 <uartinit>
  pinit();         // process table
8010308d:	e8 3e 08 00 00       	call   801038d0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 b9 29 00 00       	call   80105a50 <tvinit>
  binit();         // buffer cache
...
801030c0:	69 05 e0 36 11 80 b0 	imul   $0xb0,0x801136e0,%eax
801030c7:	00 00 00 
801030ca:	05 60 31 11 80       	add    $0x80113160,%eax
801030cf:	3d 60 31 11 80       	cmp    $0x80113160,%eax
801030d4:	76 7a                	jbe    80103150 <main+0x110>
801030d6:	bb 60 31 11 80       	mov    $0x80113160,%ebx
801030db:	eb 1c                	jmp    801030f9 <main+0xb9>
801030dd:	8d 76 00             	lea    0x0(%esi),%esi
801030e0:	69 05 e0 36 11 80 b0 	imul   $0xb0,0x801136e0,%eax
801030e7:	00 00 00 
801030ea:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
801030f0:	05 60 31 11 80       	add    $0x80113160,%eax
...
801032be:	a3 5c 30 11 80       	mov    %eax,0x8011305c
...
8010334c:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
8010334f:	88 0d 40 31 11 80    	mov    %cl,0x80113140
      continue;
80103355:	eb 89                	jmp    801032e0 <mpinit+0xf0>
80103357:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010335e:	66 90                	xchg   %ax,%ax
      if(ncpu < NCPU) {
80103360:	8b 0d e0 36 11 80    	mov    0x801136e0,%ecx
...
80103378:	89 0d e0 36 11 80    	mov    %ecx,0x801136e0
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010337e:	88 9f 60 31 11 80    	mov    %bl,-0x7feecea0(%edi)
...
80103533:	e8 48 0c 00 00       	call   80104180 <wakeup>
...
80103574:	e8 07 0c 00 00       	call   80104180 <wakeup>
...
80103608:	e8 73 0b 00 00       	call   80104180 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010360d:	58                   	pop    %eax
8010360e:	5a                   	pop    %edx
...
8010368a:	e8 f1 0a 00 00       	call   80104180 <wakeup>
  release(&p->lock);
...
80103756:	e8 25 0a 00 00       	call   80104180 <wakeup>
  release(&p->lock);
...
80103794:	bb 34 37 11 80       	mov    $0x80113734,%ebx
{
80103799:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010379c:	68 00 37 11 80       	push   $0x80113700
...
801037b6:	81 fb 34 58 11 80    	cmp    $0x80115834,%ebx
...
801037e2:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037e5:	68 00 37 11 80       	push   $0x80113700
  p->pid = nextpid++;
801037ea:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  alltick += 1;
801037f0:	83 05 b8 a5 10 80 01 	addl   $0x1,0x8010a5b8
  release(&ptable.lock);
801037f7:	e8 54 0f 00 00       	call   80104750 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
801037fc:	e8 2f ee ff ff       	call   80102630 <kalloc>
80103801:	83 c4 10             	add    $0x10,%esp
80103804:	89 43 08             	mov    %eax,0x8(%ebx)
80103807:	85 c0                	test   %eax,%eax
80103809:	74 56                	je     80103861 <allocproc+0xd1>
    return 0;
  }
...
80103819:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010381c:	c7 40 14 37 5a 10 80 	movl   $0x80105a37,0x14(%eax)
  p->context = (struct context*)sp;
...
8010382b:	e8 70 0f 00 00       	call   801047a0 <memset>
...
80103833:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103836:	c7 40 10 80 38 10 80 	movl   $0x80103880,0x10(%eax)
}
...
8010384b:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
8010384d:	68 00 37 11 80       	push   $0x80113700
80103852:	e8 f9 0e 00 00       	call   80104750 <release>
}
...
80103887:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
8010388a:	68 00 37 11 80       	push   $0x80113700
8010388f:	e8 bc 0e 00 00       	call   80104750 <release>
...
801038da:	68 c0 79 10 80       	push   $0x801079c0
801038df:	68 00 37 11 80       	push   $0x80113700
801038e4:	e8 27 0c 00 00       	call   80104510 <initlock>
}
...
80103900:	e8 9b ef ff ff       	call   801028a0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103905:	8b 35 e0 36 11 80    	mov    0x801136e0,%esi
  apicid = lapicid();
...
80103925:	0f b6 81 60 31 11 80 	movzbl -0x7feecea0(%ecx),%eax
8010392c:	39 d8                	cmp    %ebx,%eax
8010392e:	75 e8                	jne    80103918 <mycpu+0x28>
}
80103930:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
80103933:	8d 81 60 31 11 80    	lea    -0x7feecea0(%ecx),%eax
}
80103939:	5b                   	pop    %ebx
8010393a:	5e                   	pop    %esi
8010393b:	5d                   	pop    %ebp
...
8010396f:	c9                   	leave  
  return mycpu()-cpus;
80103970:	2d 60 31 11 80       	sub    $0x80113160,%eax
...
80103988:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010398b:	e8 00 0c 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103990:	e8 5b ff ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103995:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010399b:	e8 40 0c 00 00       	call   801045e0 <popcli>
}
...
801039c0:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039c2:	a3 bc a5 10 80       	mov    %eax,0x8010a5bc
  if((p->pgdir = setupkvm()) == 0)
801039c7:	e8 34 36 00 00       	call   80107000 <setupkvm>
...
801039df:	68 64 a4 10 80       	push   $0x8010a464
801039e4:	50                   	push   %eax
801039e5:	e8 e6 32 00 00       	call   80106cd0 <inituvm>
...
801039fa:	e8 a1 0d 00 00       	call   801047a0 <memset>
...
80103a53:	68 f0 79 10 80       	push   $0x801079f0
80103a58:	50                   	push   %eax
80103a59:	e8 02 0f 00 00       	call   80104960 <safestrcpy>
  p->cwd = namei("/");
80103a5e:	c7 04 24 f9 79 10 80 	movl   $0x801079f9,(%esp)
80103a65:	e8 c6 e5 ff ff       	call   80102030 <namei>
80103a6a:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a6d:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
80103a74:	e8 17 0c 00 00       	call   80104690 <acquire>
  p->state = RUNNABLE;
80103a79:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a80:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
80103a87:	e8 c4 0c 00 00       	call   80104750 <release>
}
...
80103a97:	68 d7 79 10 80       	push   $0x801079d7
...
80103ab9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103abc:	e8 cf 0a 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103ac1:	e8 2a fe ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103ac6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103acc:	e8 0f 0b 00 00       	call   801045e0 <popcli>
  sz = curproc->sz;
...
80103adf:	e8 dc 30 00 00       	call   80106bc0 <switchuvm>
  return 0;
...
80103afa:	e8 21 33 00 00       	call   80106e20 <allocuvm>
...
80103b1a:	e8 31 34 00 00       	call   80106f50 <deallocuvm>
...
80103b3a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b3d:	e8 4e 0a 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103b42:	e8 a9 fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b47:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b4d:	e8 8e 0a 00 00       	call   801045e0 <popcli>
  if((np = allocproc()) == 0){
...
80103b6c:	e8 5f 35 00 00       	call   801070d0 <copyuvm>
80103b71:	83 c4 10             	add    $0x10,%esp
80103b74:	89 47 04             	mov    %eax,0x4(%edi)
80103b77:	85 c0                	test   %eax,%eax
80103b79:	0f 84 ad 00 00 00    	je     80103c2c <fork+0xfc>
  np->sz = curproc->sz;
...
80103b84:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->sz = curproc->sz;
80103b89:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
80103b8b:	8b 7a 18             	mov    0x18(%edx),%edi
  np->parent = curproc;
80103b8e:	89 5a 14             	mov    %ebx,0x14(%edx)
  *np->tf = *curproc->tf;
80103b91:	8b 73 18             	mov    0x18(%ebx),%esi
80103b94:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103b96:	31 f6                	xor    %esi,%esi
  np->tickets = curproc->tickets;
80103b98:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103b9b:	89 42 7c             	mov    %eax,0x7c(%edx)
  np->tf->eax = 0;
80103b9e:	8b 42 18             	mov    0x18(%edx),%eax
80103ba1:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
...
80103bf1:	e8 6a 0d 00 00       	call   80104960 <safestrcpy>
  pid = np->pid;
80103bf6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bf9:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
80103c00:	e8 8b 0a 00 00       	call   80104690 <acquire>
  np->state = RUNNABLE;
80103c05:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103c0c:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
80103c13:	e8 38 0b 00 00       	call   80104750 <release>
  return pid;
...
80103c7c:	89 c6                	mov    %eax,%esi
  c->proc = 0;
80103c7e:	8d 40 04             	lea    0x4(%eax),%eax
80103c81:	89 45 e0             	mov    %eax,-0x20(%ebp)
80103c84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  asm volatile("sti");
80103c88:	fb                   	sti    
    alltick = 0;
80103c89:	c7 05 b8 a5 10 80 00 	movl   $0x0,0x8010a5b8
80103c90:	00 00 00 
80103c93:	31 c9                	xor    %ecx,%ecx
80103c95:	31 d2                	xor    %edx,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c97:	b8 34 37 11 80       	mov    $0x80113734,%eax
80103c9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(p->state == RUNNABLE) alltick += p->tickets;
80103ca0:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103ca4:	75 08                	jne    80103cae <scheduler+0x4e>
80103ca6:	03 50 7c             	add    0x7c(%eax),%edx
80103ca9:	b9 01 00 00 00       	mov    $0x1,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cae:	05 84 00 00 00       	add    $0x84,%eax
80103cb3:	3d 34 58 11 80       	cmp    $0x80115834,%eax
80103cb8:	75 e6                	jne    80103ca0 <scheduler+0x40>
80103cba:	84 c9                	test   %cl,%cl
80103cbc:	74 06                	je     80103cc4 <scheduler+0x64>
80103cbe:	89 15 b8 a5 10 80    	mov    %edx,0x8010a5b8
    acquire(&ptable.lock);
80103cc4:	83 ec 0c             	sub    $0xc,%esp
    int counter = 0;
80103cc7:	31 db                	xor    %ebx,%ebx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cc9:	bf 34 37 11 80       	mov    $0x80113734,%edi
    acquire(&ptable.lock);
80103cce:	68 00 37 11 80       	push   $0x80113700
80103cd3:	e8 b8 09 00 00       	call   80104690 <acquire>
    int ticket = random_at_most(alltick);
80103cd8:	59                   	pop    %ecx
80103cd9:	ff 35 b8 a5 10 80    	pushl  0x8010a5b8
80103cdf:	e8 4c 37 00 00       	call   80107430 <random_at_most>
80103ce4:	83 c4 10             	add    $0x10,%esp
80103ce7:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->state != RUNNABLE)
80103cf0:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103cf4:	75 44                	jne    80103d3a <scheduler+0xda>
      counter += p->tickets;
80103cf6:	03 5f 7c             	add    0x7c(%edi),%ebx
      if(counter < ticket) continue;
80103cf9:	39 5d e4             	cmp    %ebx,-0x1c(%ebp)
80103cfc:	7f 3c                	jg     80103d3a <scheduler+0xda>
      switchuvm(p);
80103cfe:	83 ec 0c             	sub    $0xc,%esp
      p->ticks++;
80103d01:	83 87 80 00 00 00 01 	addl   $0x1,0x80(%edi)
      c->proc = p;
80103d08:	89 be ac 00 00 00    	mov    %edi,0xac(%esi)
      switchuvm(p);
80103d0e:	57                   	push   %edi
80103d0f:	e8 ac 2e 00 00       	call   80106bc0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103d14:	58                   	pop    %eax
80103d15:	5a                   	pop    %edx
80103d16:	ff 77 1c             	pushl  0x1c(%edi)
80103d19:	ff 75 e0             	pushl  -0x20(%ebp)
      p->state = RUNNING;
80103d1c:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p->context);
80103d23:	e8 9b 0c 00 00       	call   801049c3 <swtch>
      switchkvm();
80103d28:	e8 73 2e 00 00       	call   80106ba0 <switchkvm>
      c->proc = 0;
80103d2d:	83 c4 10             	add    $0x10,%esp
80103d30:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103d37:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d3a:	81 c7 84 00 00 00    	add    $0x84,%edi
80103d40:	81 ff 34 58 11 80    	cmp    $0x80115834,%edi
80103d46:	75 a8                	jne    80103cf0 <scheduler+0x90>
    release(&ptable.lock);
80103d48:	83 ec 0c             	sub    $0xc,%esp
80103d4b:	68 00 37 11 80       	push   $0x80113700
80103d50:	e8 fb 09 00 00       	call   80104750 <release>
  for(;;){
80103d55:	83 c4 10             	add    $0x10,%esp
80103d58:	e9 2b ff ff ff       	jmp    80103c88 <scheduler+0x28>
...
80103d81:	68 00 37 11 80       	push   $0x80113700
...
80103dc7:	e8 f7 0b 00 00       	call   801049c3 <swtch>
  mycpu()->intena = intena;
...
80103e48:	39 35 bc a5 10 80    	cmp    %esi,0x8010a5bc
...
80103e8c:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103e93:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
...
80103ed3:	3d 34 58 11 80       	cmp    $0x80115834,%eax
80103ed8:	75 e2                	jne    80103ebc <exit+0x9c>
      p->parent = initproc;
80103eda:	8b 0d bc a5 10 80    	mov    0x8010a5bc,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ee0:	ba 34 37 11 80       	mov    $0x80113734,%edx
...
80103ef6:	81 fa 34 58 11 80    	cmp    $0x80115834,%edx
...
80103f47:	68 48 7a 10 80       	push   $0x80107a48
80103f4c:	e8 3f c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103f51:	83 ec 0c             	sub    $0xc,%esp
80103f54:	68 3b 7a 10 80       	push   $0x80107a3b
...
80103f6b:	68 00 37 11 80       	push   $0x80113700
...
80103f91:	e8 ca fd ff ff       	call   80103d60 <sched>
  release(&ptable.lock);
80103f96:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
...
80103fe4:	81 fe 00 37 11 80    	cmp    $0x80113700,%esi
80103fea:	74 4c                	je     80104038 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103fec:	83 ec 0c             	sub    $0xc,%esp
80103fef:	68 00 37 11 80       	push   $0x80113700
...
80104010:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80104017:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
...
80104059:	68 5a 7a 10 80       	push   $0x80107a5a
8010405e:	e8 2d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104063:	83 ec 0c             	sub    $0xc,%esp
80104066:	68 54 7a 10 80       	push   $0x80107a54
...
801040b6:	81 fb 34 58 11 80    	cmp    $0x80115834,%ebx
...
80104112:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104119:	e8 62 2e 00 00       	call   80106f80 <freevm>
        release(&ptable.lock);
8010411e:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
        p->pid = 0;
...
8010413e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
	p->tickets = 0;
80104145:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        release(&ptable.lock);
8010414c:	e8 ff 05 00 00       	call   80104750 <release>
        return pid;
80104151:	83 c4 10             	add    $0x10,%esp
}
80104154:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104157:	89 f0                	mov    %esi,%eax
80104159:	5b                   	pop    %ebx
8010415a:	5e                   	pop    %esi
8010415b:	5d                   	pop    %ebp
8010415c:	c3                   	ret    
...
8010415d:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104160:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104165:	68 00 37 11 80       	push   $0x80113700
8010416a:	e8 e1 05 00 00       	call   80104750 <release>
      return -1;
8010416f:	83 c4 10             	add    $0x10,%esp
80104172:	eb e0                	jmp    80104154 <wait+0xe4>
...
8010418b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010418e:	68 00 37 11 80       	push   $0x80113700
80104193:	e8 f8 04 00 00       	call   80104690 <acquire>
80104198:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010419b:	b8 34 37 11 80       	mov    $0x80113734,%eax
801041a0:	eb 12                	jmp    801041b4 <wakeup+0x34>
801041a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801041a8:	05 84 00 00 00       	add    $0x84,%eax
801041ad:	3d 34 58 11 80       	cmp    $0x80115834,%eax
801041b2:	74 1e                	je     801041d2 <wakeup+0x52>
    if(p->state == SLEEPING && p->chan == chan)
801041b4:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
801041b8:	75 ee                	jne    801041a8 <wakeup+0x28>
801041ba:	3b 58 20             	cmp    0x20(%eax),%ebx
801041bd:	75 e9                	jne    801041a8 <wakeup+0x28>
      p->state = RUNNABLE;
801041bf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041c6:	05 84 00 00 00       	add    $0x84,%eax
801041cb:	3d 34 58 11 80       	cmp    $0x80115834,%eax
801041d0:	75 e2                	jne    801041b4 <wakeup+0x34>
  wakeup1(chan);
  release(&ptable.lock);
801041d2:	c7 45 08 00 37 11 80 	movl   $0x80113700,0x8(%ebp)
}
801041d9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801041dc:	c9                   	leave  
  release(&ptable.lock);
801041dd:	e9 6e 05 00 00       	jmp    80104750 <release>
...
801041fb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
801041fe:	68 00 37 11 80       	push   $0x80113700
80104203:	e8 88 04 00 00       	call   80104690 <acquire>
80104208:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010420b:	b8 34 37 11 80       	mov    $0x80113734,%eax
80104210:	eb 12                	jmp    80104224 <kill+0x34>
80104212:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104218:	05 84 00 00 00       	add    $0x84,%eax
8010421d:	3d 34 58 11 80       	cmp    $0x80115834,%eax
80104222:	74 34                	je     80104258 <kill+0x68>
    if(p->pid == pid){
80104224:	39 58 10             	cmp    %ebx,0x10(%eax)
80104227:	75 ef                	jne    80104218 <kill+0x28>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104229:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
8010422d:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
80104234:	75 07                	jne    8010423d <kill+0x4d>
        p->state = RUNNABLE;
80104236:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
8010423d:	83 ec 0c             	sub    $0xc,%esp
80104240:	68 00 37 11 80       	push   $0x80113700
80104245:	e8 06 05 00 00       	call   80104750 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
8010425b:	68 00 37 11 80       	push   $0x80113700
80104260:	e8 eb 04 00 00       	call   80104750 <release>
}
...
80104289:	8d 75 e8             	lea    -0x18(%ebp),%esi
8010428c:	53                   	push   %ebx
8010428d:	bb a0 37 11 80       	mov    $0x801137a0,%ebx
80104292:	83 ec 3c             	sub    $0x3c,%esp
80104295:	eb 2b                	jmp    801042c2 <procdump+0x42>
...
801042a3:	68 df 7d 10 80       	push   $0x80107ddf
801042a8:	e8 03 c4 ff ff       	call   801006b0 <cprintf>
801042ad:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042b0:	81 c3 84 00 00 00    	add    $0x84,%ebx
801042b6:	81 fb a0 58 11 80    	cmp    $0x801158a0,%ebx
801042bc:	0f 84 8e 00 00 00    	je     80104350 <procdump+0xd0>
    if(p->state == UNUSED)
801042c2:	8b 43 a0             	mov    -0x60(%ebx),%eax
801042c5:	85 c0                	test   %eax,%eax
801042c7:	74 e7                	je     801042b0 <procdump+0x30>
      state = "???";
801042c9:	ba 6b 7a 10 80       	mov    $0x80107a6b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042ce:	83 f8 05             	cmp    $0x5,%eax
801042d1:	77 11                	ja     801042e4 <procdump+0x64>
801042d3:	8b 14 85 cc 7a 10 80 	mov    -0x7fef8534(,%eax,4),%edx
      state = "???";
801042da:	b8 6b 7a 10 80       	mov    $0x80107a6b,%eax
801042df:	85 d2                	test   %edx,%edx
801042e1:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
801042e4:	53                   	push   %ebx
801042e5:	52                   	push   %edx
801042e6:	ff 73 a4             	pushl  -0x5c(%ebx)
801042e9:	68 6f 7a 10 80       	push   $0x80107a6f
801042ee:	e8 bd c3 ff ff       	call   801006b0 <cprintf>
    if(p->state == SLEEPING){
801042f3:	83 c4 10             	add    $0x10,%esp
801042f6:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
801042fa:	75 a4                	jne    801042a0 <procdump+0x20>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801042fc:	83 ec 08             	sub    $0x8,%esp
801042ff:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104302:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104305:	50                   	push   %eax
80104306:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104309:	8b 40 0c             	mov    0xc(%eax),%eax
8010430c:	83 c0 08             	add    $0x8,%eax
8010430f:	50                   	push   %eax
80104310:	e8 1b 02 00 00       	call   80104530 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010436a:	fb                   	sti    
  ...
  struct proc *p;
  acquire(&ptable.lock);
8010436b:	68 00 37 11 80       	push   $0x80113700
80104370:	e8 1b 03 00 00       	call   80104690 <acquire>
  int i = 0;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++,i++){
80104375:	8b 55 08             	mov    0x8(%ebp),%edx
80104378:	83 c4 10             	add    $0x10,%esp
8010437b:	b8 34 37 11 80       	mov    $0x80113734,%eax
     if(p->state == UNUSED) ps->inuse[i] = 0;
80104380:	31 c9                	xor    %ecx,%ecx
80104382:	83 78 0c 00          	cmpl   $0x0,0xc(%eax)
80104386:	0f 95 c1             	setne  %cl
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++,i++){
80104389:	05 84 00 00 00       	add    $0x84,%eax
8010438e:	83 c2 04             	add    $0x4,%edx
80104391:	89 4a fc             	mov    %ecx,-0x4(%edx)
     else ps->inuse[i] = 1;
     ps->tickets[i] = p->tickets;
80104394:	8b 48 f8             	mov    -0x8(%eax),%ecx
80104397:	89 8a fc 00 00 00    	mov    %ecx,0xfc(%edx)
     ps->pid[i] = p->pid;
8010439d:	8b 48 8c             	mov    -0x74(%eax),%ecx
801043a0:	89 8a fc 01 00 00    	mov    %ecx,0x1fc(%edx)
     ps->ticks[i] = p->ticks; 
801043a6:	8b 48 fc             	mov    -0x4(%eax),%ecx
801043a9:	89 8a fc 02 00 00    	mov    %ecx,0x2fc(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++,i++){
801043af:	3d 34 58 11 80       	cmp    $0x80115834,%eax
801043b4:	75 ca                	jne    80104380 <getpinfo+0x20>
  }
  release(&ptable.lock);
801043b6:	83 ec 0c             	sub    $0xc,%esp
801043b9:	68 00 37 11 80       	push   $0x80113700
801043be:	e8 8d 03 00 00       	call   80104750 <release>
  return 0;
}
...
801043de:	68 e4 7a 10 80       	push   $0x80107ae4
...
8010444b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104451:	e8 2a f5 ff ff       	call   80103980 <myproc>
...
80104498:	e8 e3 fc ff ff       	call   80104180 <wakeup>
  release(&lk->lk);
...
801044f3:	e8 88 f4 ff ff       	call   80103980 <myproc>
...
80104625:	68 ef 7a 10 80       	push   $0x80107aef
8010462a:	e8 61 bd ff ff       	call   80100390 <panic>
    panic("popcli");
8010462f:	83 ec 0c             	sub    $0xc,%esp
80104632:	68 06 7b 10 80       	push   $0x80107b06
...
80104737:	68 0d 7b 10 80       	push   $0x80107b0d
...
80104790:	68 15 7b 10 80       	push   $0x80107b15
...
801049eb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801049ee:	e8 8d ef ff ff       	call   80103980 <myproc>
...
80104a97:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a9a:	e8 e1 ee ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104adc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104adf:	e8 9c ee ff ff       	call   80103980 <myproc>
...
80104b78:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b7b:	e8 00 ee ff ff       	call   80103980 <myproc>
...
80104b8b:	83 fa 16             	cmp    $0x16,%edx
80104b8e:	77 20                	ja     80104bb0 <syscall+0x40>
80104b90:	8b 14 85 40 7b 10 80 	mov    -0x7fef84c0(,%eax,4),%edx
...
80104bb8:	68 1d 7b 10 80       	push   $0x80107b1d
...
80104d14:	68 bc 7b 10 80       	push   $0x80107bbc
...
80104d2c:	68 bb 7b 10 80       	push   $0x80107bbb
...
80104d41:	68 af 7b 10 80       	push   $0x80107baf
...
80104d5f:	68 be 7b 10 80       	push   $0x80107bbe
80104d64:	e8 27 b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104d69:	83 ec 0c             	sub    $0xc,%esp
80104d6c:	68 a0 7b 10 80       	push   $0x80107ba0
...
80104da4:	e8 d7 eb ff ff       	call   80103980 <myproc>
...
80104ded:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104def:	e8 8c eb ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010515d:	58                   	pop    %eax
8010515e:	5a                   	pop    %edx
8010515f:	68 bc 7b 10 80       	push   $0x80107bbc
...
80105178:	68 bb 7b 10 80       	push   $0x80107bbb
...
80105549:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010554c:	e8 2f e4 ff ff       	call   80103980 <myproc>
...
8010572b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010572d:	e8 4e e2 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801057d0:	f3 0f 1e fb          	endbr32 
  return fork();
801057d4:	e9 57 e3 ff ff       	jmp    80103b30 <fork>
...
80105832:	e8 b9 e9 ff ff       	call   801041f0 <kill>
...
80105857:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
8010585a:	e8 21 e1 ff ff       	call   80103980 <myproc>
...
8010588b:	78 23                	js     801058b0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010588d:	e8 ee e0 ff ff       	call   80103980 <myproc>
  if(growproc(n) < 0)
...
8010589a:	e8 11 e2 ff ff       	call   80103ab0 <growproc>
...
801058e4:	68 40 58 11 80       	push   $0x80115840
801058e9:	e8 a2 ed ff ff       	call   80104690 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801058ee:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801058f1:	8b 1d 80 60 11 80    	mov    0x80116080,%ebx
  while(ticks - ticks0 < n){
...
80105903:	68 40 58 11 80       	push   $0x80115840
80105908:	68 80 60 11 80       	push   $0x80116080
8010590d:	e8 9e e6 ff ff       	call   80103fb0 <sleep>
  while(ticks - ticks0 < n){
80105912:	a1 80 60 11 80       	mov    0x80116080,%eax
...
80105930:	68 40 58 11 80       	push   $0x80115840
...
80105953:	68 40 58 11 80       	push   $0x80115840
...
80105978:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
8010597b:	68 40 58 11 80       	push   $0x80115840
80105980:	e8 0b ed ff ff       	call   80104690 <acquire>
  xticks = ticks;
80105985:	8b 1d 80 60 11 80    	mov    0x80116080,%ebx
  release(&tickslock);
8010598b:	c7 04 24 40 58 11 80 	movl   $0x80115840,(%esp)
...
801059bf:	e8 bc df ff ff       	call   80103980 <myproc>
...
801059ed:	68 00 04 00 00       	push   $0x400
801059f2:	50                   	push   %eax
801059f3:	6a 00                	push   $0x0
801059f5:	e8 d6 f0 ff ff       	call   80104ad0 <argptr>
801059fa:	83 c4 10             	add    $0x10,%esp
801059fd:	85 c0                	test   %eax,%eax
801059ff:	78 17                	js     80105a18 <sys_getpinfo+0x38>
    return -1;
  return getpinfo(ps);
80105a01:	83 ec 0c             	sub    $0xc,%esp
80105a04:	ff 75 f4             	pushl  -0xc(%ebp)
80105a07:	e8 54 e9 ff ff       	call   80104360 <getpinfo>
...
80105a9e:	00 00 ef 
  initlock(&tickslock, "time");
80105aa1:	68 01 7c 10 80       	push   $0x80107c01
...
80105ab4:	66 a3 86 5a 11 80    	mov    %ax,0x80115a86
  initlock(&tickslock, "time");
80105aba:	e8 51 ea ff ff       	call   80104510 <initlock>
}
...
80105ad4:	55                   	push   %ebp
  pd[0] = size-1;
80105ad5:	b8 ff 07 00 00       	mov    $0x7ff,%eax
80105ada:	89 e5                	mov    %esp,%ebp
80105adc:	83 ec 10             	sub    $0x10,%esp
80105adf:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105ae3:	b8 80 58 11 80       	mov    $0x80115880,%eax
80105ae8:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80105aec:	c1 e8 10             	shr    $0x10,%eax
80105aef:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80105af3:	8d 45 fa             	lea    -0x6(%ebp),%eax
80105af6:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80105af9:	c9                   	leave  
80105afa:	c3                   	ret    
...
80105b0a:	83 ec 1c             	sub    $0x1c,%esp
80105b0d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105b10:	8b 43 30             	mov    0x30(%ebx),%eax
80105b13:	83 f8 40             	cmp    $0x40,%eax
80105b16:	0f 84 bc 01 00 00    	je     80105cd8 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105b1c:	83 e8 20             	sub    $0x20,%eax
80105b1f:	83 f8 1f             	cmp    $0x1f,%eax
80105b22:	77 08                	ja     80105b2c <trap+0x2c>
80105b24:	3e ff 24 85 a8 7c 10 	notrack jmp *-0x7fef8358(,%eax,4)
80105b2b:	80 
    lapiceoi();
    break;
...
80105b2c:	e8 4f de ff ff       	call   80103980 <myproc>
80105b31:	8b 7b 38             	mov    0x38(%ebx),%edi
80105b34:	85 c0                	test   %eax,%eax
80105b36:	0f 84 eb 01 00 00    	je     80105d27 <trap+0x227>
80105b3c:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105b40:	0f 84 e1 01 00 00    	je     80105d27 <trap+0x227>
...
80105b46:	0f 20 d1             	mov    %cr2,%ecx
80105b49:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80105b4c:	e8 0f de ff ff       	call   80103960 <cpuid>
80105b51:	8b 73 30             	mov    0x30(%ebx),%esi
80105b54:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105b57:	8b 43 34             	mov    0x34(%ebx),%eax
80105b5a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105b5d:	e8 1e de ff ff       	call   80103980 <myproc>
80105b62:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105b65:	e8 16 de ff ff       	call   80103980 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105b6a:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105b6d:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105b70:	51                   	push   %ecx
80105b71:	57                   	push   %edi
80105b72:	52                   	push   %edx
80105b73:	ff 75 e4             	pushl  -0x1c(%ebp)
80105b76:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105b77:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105b7a:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105b7d:	56                   	push   %esi
80105b7e:	ff 70 10             	pushl  0x10(%eax)
80105b81:	68 64 7c 10 80       	push   $0x80107c64
80105b86:	e8 25 ab ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105b8b:	83 c4 20             	add    $0x20,%esp
80105b8e:	e8 ed dd ff ff       	call   80103980 <myproc>
80105b93:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
80105b9a:	e8 e1 dd ff ff       	call   80103980 <myproc>
80105b9f:	85 c0                	test   %eax,%eax
80105ba1:	74 1d                	je     80105bc0 <trap+0xc0>
80105ba3:	e8 d8 dd ff ff       	call   80103980 <myproc>
80105ba8:	8b 50 24             	mov    0x24(%eax),%edx
80105bab:	85 d2                	test   %edx,%edx
80105bad:	74 11                	je     80105bc0 <trap+0xc0>
80105baf:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105bb3:	83 e0 03             	and    $0x3,%eax
80105bb6:	66 83 f8 03          	cmp    $0x3,%ax
80105bba:	0f 84 50 01 00 00    	je     80105d10 <trap+0x210>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105bc0:	e8 bb dd ff ff       	call   80103980 <myproc>
80105bc5:	85 c0                	test   %eax,%eax
80105bc7:	74 0f                	je     80105bd8 <trap+0xd8>
80105bc9:	e8 b2 dd ff ff       	call   80103980 <myproc>
80105bce:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105bd2:	0f 84 e8 00 00 00    	je     80105cc0 <trap+0x1c0>
...
80105bf8:	0f 84 03 01 00 00    	je     80105d01 <trap+0x201>
    exit();
}
...
80105c05:	c3                   	ret    
    ideintr();
80105c06:	e8 d5 c5 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105c0b:	e8 b0 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c10:	e8 6b dd ff ff       	call   80103980 <myproc>
80105c15:	85 c0                	test   %eax,%eax
80105c17:	75 8a                	jne    80105ba3 <trap+0xa3>
80105c19:	eb a5                	jmp    80105bc0 <trap+0xc0>
    if(cpuid() == 0){
80105c1b:	e8 40 dd ff ff       	call   80103960 <cpuid>
80105c20:	85 c0                	test   %eax,%eax
80105c22:	75 e7                	jne    80105c0b <trap+0x10b>
      acquire(&tickslock);
80105c24:	83 ec 0c             	sub    $0xc,%esp
80105c27:	68 40 58 11 80       	push   $0x80115840
80105c2c:	e8 5f ea ff ff       	call   80104690 <acquire>
      wakeup(&ticks);
80105c31:	c7 04 24 80 60 11 80 	movl   $0x80116080,(%esp)
      ticks++;
80105c38:	83 05 80 60 11 80 01 	addl   $0x1,0x80116080
      wakeup(&ticks);
80105c3f:	e8 3c e5 ff ff       	call   80104180 <wakeup>
      release(&tickslock);
80105c44:	c7 04 24 40 58 11 80 	movl   $0x80115840,(%esp)
80105c4b:	e8 00 eb ff ff       	call   80104750 <release>
80105c50:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105c53:	eb b6                	jmp    80105c0b <trap+0x10b>
    kbdintr();
80105c55:	e8 26 cb ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105c5a:	e8 61 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c5f:	e8 1c dd ff ff       	call   80103980 <myproc>
80105c64:	85 c0                	test   %eax,%eax
80105c66:	0f 85 37 ff ff ff    	jne    80105ba3 <trap+0xa3>
80105c6c:	e9 4f ff ff ff       	jmp    80105bc0 <trap+0xc0>
    uartintr();
80105c71:	e8 4a 02 00 00       	call   80105ec0 <uartintr>
    lapiceoi();
80105c76:	e8 45 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c7b:	e8 00 dd ff ff       	call   80103980 <myproc>
80105c80:	85 c0                	test   %eax,%eax
80105c82:	0f 85 1b ff ff ff    	jne    80105ba3 <trap+0xa3>
80105c88:	e9 33 ff ff ff       	jmp    80105bc0 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105c8d:	8b 7b 38             	mov    0x38(%ebx),%edi
80105c90:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105c94:	e8 c7 dc ff ff       	call   80103960 <cpuid>
80105c99:	57                   	push   %edi
80105c9a:	56                   	push   %esi
80105c9b:	50                   	push   %eax
80105c9c:	68 0c 7c 10 80       	push   $0x80107c0c
80105ca1:	e8 0a aa ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105ca6:	e8 15 cc ff ff       	call   801028c0 <lapiceoi>
    break;
80105cab:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cae:	e8 cd dc ff ff       	call   80103980 <myproc>
80105cb3:	85 c0                	test   %eax,%eax
80105cb5:	0f 85 e8 fe ff ff    	jne    80105ba3 <trap+0xa3>
80105cbb:	e9 00 ff ff ff       	jmp    80105bc0 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105cc0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105cc4:	0f 85 0e ff ff ff    	jne    80105bd8 <trap+0xd8>
    yield();
80105cca:	e8 91 e2 ff ff       	call   80103f60 <yield>
80105ccf:	e9 04 ff ff ff       	jmp    80105bd8 <trap+0xd8>
80105cd4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105cd8:	e8 a3 dc ff ff       	call   80103980 <myproc>
80105cdd:	8b 70 24             	mov    0x24(%eax),%esi
80105ce0:	85 f6                	test   %esi,%esi
80105ce2:	75 3c                	jne    80105d20 <trap+0x220>
    myproc()->tf = tf;
80105ce4:	e8 97 dc ff ff       	call   80103980 <myproc>
80105ce9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105cec:	e8 7f ee ff ff       	call   80104b70 <syscall>
    if(myproc()->killed)
80105cf1:	e8 8a dc ff ff       	call   80103980 <myproc>
80105cf6:	8b 48 24             	mov    0x24(%eax),%ecx
80105cf9:	85 c9                	test   %ecx,%ecx
80105cfb:	0f 84 fd fe ff ff    	je     80105bfe <trap+0xfe>
}
...
80105d07:	5d                   	pop    %ebp
      exit();
80105d08:	e9 13 e1 ff ff       	jmp    80103e20 <exit>
80105d0d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105d10:	e8 0b e1 ff ff       	call   80103e20 <exit>
80105d15:	e9 a6 fe ff ff       	jmp    80105bc0 <trap+0xc0>
80105d1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d20:	e8 fb e0 ff ff       	call   80103e20 <exit>
80105d25:	eb bd                	jmp    80105ce4 <trap+0x1e4>
80105d27:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d2a:	e8 31 dc ff ff       	call   80103960 <cpuid>
...
80105d38:	68 30 7c 10 80       	push   $0x80107c30
80105d3d:	e8 6e a9 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105d42:	83 c4 14             	add    $0x14,%esp
80105d45:	68 06 7c 10 80       	push   $0x80107c06
80105d4a:	e8 41 a6 ff ff       	call   80100390 <panic>
80105d4f:	90                   	nop
...
80105d50:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105d54:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
80105d59:	85 c0                	test   %eax,%eax
80105d5b:	74 1b                	je     80105d78 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105d5d:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105d62:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105d63:	a8 01                	test   $0x1,%al
80105d65:	74 11                	je     80105d78 <uartgetc+0x28>
80105d67:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105d6c:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105d6d:	0f b6 c0             	movzbl %al,%eax
80105d70:	c3                   	ret    
...
80105d87:	be fd 03 00 00       	mov    $0x3fd,%esi
...
80105da5:	e8 36 cb ff ff       	call   801028e0 <microdelay>
...
80105dd5:	31 c9                	xor    %ecx,%ecx
80105dd7:	89 c8                	mov    %ecx,%eax
80105dd9:	89 e5                	mov    %esp,%ebp
80105ddb:	57                   	push   %edi
80105ddc:	56                   	push   %esi
80105ddd:	53                   	push   %ebx
80105dde:	bb fa 03 00 00       	mov    $0x3fa,%ebx
80105de3:	89 da                	mov    %ebx,%edx
80105de5:	83 ec 0c             	sub    $0xc,%esp
80105de8:	ee                   	out    %al,(%dx)
80105de9:	bf fb 03 00 00       	mov    $0x3fb,%edi
80105dee:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105df3:	89 fa                	mov    %edi,%edx
80105df5:	ee                   	out    %al,(%dx)
80105df6:	b8 0c 00 00 00       	mov    $0xc,%eax
80105dfb:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e00:	ee                   	out    %al,(%dx)
80105e01:	be f9 03 00 00       	mov    $0x3f9,%esi
80105e06:	89 c8                	mov    %ecx,%eax
80105e08:	89 f2                	mov    %esi,%edx
80105e0a:	ee                   	out    %al,(%dx)
80105e0b:	b8 03 00 00 00       	mov    $0x3,%eax
80105e10:	89 fa                	mov    %edi,%edx
80105e12:	ee                   	out    %al,(%dx)
80105e13:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105e18:	89 c8                	mov    %ecx,%eax
80105e1a:	ee                   	out    %al,(%dx)
80105e1b:	b8 01 00 00 00       	mov    $0x1,%eax
80105e20:	89 f2                	mov    %esi,%edx
80105e22:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105e23:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105e28:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105e29:	3c ff                	cmp    $0xff,%al
80105e2b:	74 52                	je     80105e7f <uartinit+0xaf>
  uart = 1;
80105e2d:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105e34:	00 00 00 
80105e37:	89 da                	mov    %ebx,%edx
80105e39:	ec                   	in     (%dx),%al
80105e3a:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e3f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105e40:	83 ec 08             	sub    $0x8,%esp
80105e43:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105e48:	bb 28 7d 10 80       	mov    $0x80107d28,%ebx
  ioapicenable(IRQ_COM1, 0);
80105e4d:	6a 00                	push   $0x0
80105e4f:	6a 04                	push   $0x4
80105e51:	e8 da c5 ff ff       	call   80102430 <ioapicenable>
80105e56:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105e59:	b8 78 00 00 00       	mov    $0x78,%eax
80105e5e:	eb 04                	jmp    80105e64 <uartinit+0x94>
80105e60:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80105e64:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
80105e6a:	85 d2                	test   %edx,%edx
80105e6c:	74 08                	je     80105e76 <uartinit+0xa6>
    uartputc(*p);
80105e6e:	0f be c0             	movsbl %al,%eax
80105e71:	e8 0a ff ff ff       	call   80105d80 <uartputc.part.0>
  for(p="xv6...\n"; *p; p++)
80105e76:	89 f0                	mov    %esi,%eax
80105e78:	83 c3 01             	add    $0x1,%ebx
80105e7b:	84 c0                	test   %al,%al
80105e7d:	75 e1                	jne    80105e60 <uartinit+0x90>
}
80105e7f:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105e82:	5b                   	pop    %ebx
80105e83:	5e                   	pop    %esi
80105e84:	5f                   	pop    %edi
80105e85:	5d                   	pop    %ebp
...
80105e94:	55                   	push   %ebp
  if(!uart)
80105e95:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
{
80105e9b:	89 e5                	mov    %esp,%ebp
80105e9d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
80105ea0:	85 d2                	test   %edx,%edx
80105ea2:	74 0c                	je     80105eb0 <uartputc+0x20>
}
80105ea4:	5d                   	pop    %ebp
80105ea5:	e9 d6 fe ff ff       	jmp    80105d80 <uartputc.part.0>
...
80105ec7:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80105eca:	68 50 5d 10 80       	push   $0x80105d50
80105ecf:	e8 8c a9 ff ff       	call   80100860 <consoleintr>
}
...
80105edb:	6a 00                	push   $0x0
  jmp alltraps
80105edd:	e9 3d fb ff ff       	jmp    80105a1f <alltraps>
...
80105ee2:	6a 00                	push   $0x0
  pushl $1
80105ee4:	6a 01                	push   $0x1
  jmp alltraps
80105ee6:	e9 34 fb ff ff       	jmp    80105a1f <alltraps>
...
80105eed:	6a 02                	push   $0x2
  jmp alltraps
80105eef:	e9 2b fb ff ff       	jmp    80105a1f <alltraps>
...
80105ef4:	6a 00                	push   $0x0
  pushl $3
80105ef6:	6a 03                	push   $0x3
  jmp alltraps
80105ef8:	e9 22 fb ff ff       	jmp    80105a1f <alltraps>
...
80105eff:	6a 04                	push   $0x4
  jmp alltraps
80105f01:	e9 19 fb ff ff       	jmp    80105a1f <alltraps>
...
80105f06:	6a 00                	push   $0x0
  pushl $5
80105f08:	6a 05                	push   $0x5
  jmp alltraps
80105f0a:	e9 10 fb ff ff       	jmp    80105a1f <alltraps>
...
80105f0f:	6a 00                	push   $0x0
  pushl $6
80105f11:	6a 06                	push   $0x6
  jmp alltraps
80105f13:	e9 07 fb ff ff       	jmp    80105a1f <alltraps>
...
80105f18:	6a 00                	push   $0x0
  pushl $7
80105f1a:	6a 07                	push   $0x7
  jmp alltraps
80105f1c:	e9 fe fa ff ff       	jmp    80105a1f <alltraps>

80105f21 <vector8>:
.globl vector8
vector8:
  pushl $8
80105f21:	6a 08                	push   $0x8
  jmp alltraps
80105f23:	e9 f7 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f28:	6a 00                	push   $0x0
  pushl $9
80105f2a:	6a 09                	push   $0x9
  jmp alltraps
80105f2c:	e9 ee fa ff ff       	jmp    80105a1f <alltraps>

80105f31 <vector10>:
.globl vector10
vector10:
  pushl $10
80105f31:	6a 0a                	push   $0xa
  jmp alltraps
80105f33:	e9 e7 fa ff ff       	jmp    80105a1f <alltraps>

80105f38 <vector11>:
.globl vector11
vector11:
  pushl $11
80105f38:	6a 0b                	push   $0xb
  jmp alltraps
80105f3a:	e9 e0 fa ff ff       	jmp    80105a1f <alltraps>

80105f3f <vector12>:
.globl vector12
vector12:
  pushl $12
80105f3f:	6a 0c                	push   $0xc
  jmp alltraps
80105f41:	e9 d9 fa ff ff       	jmp    80105a1f <alltraps>

80105f46 <vector13>:
.globl vector13
vector13:
  pushl $13
80105f46:	6a 0d                	push   $0xd
  jmp alltraps
80105f48:	e9 d2 fa ff ff       	jmp    80105a1f <alltraps>

80105f4d <vector14>:
.globl vector14
vector14:
  pushl $14
80105f4d:	6a 0e                	push   $0xe
  jmp alltraps
...
80105f5d:	6a 00                	push   $0x0
  pushl $16
80105f5f:	6a 10                	push   $0x10
  jmp alltraps
80105f61:	e9 b9 fa ff ff       	jmp    80105a1f <alltraps>

80105f66 <vector17>:
.globl vector17
vector17:
  pushl $17
80105f66:	6a 11                	push   $0x11
  jmp alltraps
...
80105f6d:	6a 00                	push   $0x0
  pushl $18
80105f6f:	6a 12                	push   $0x12
  jmp alltraps
80105f71:	e9 a9 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f76:	6a 00                	push   $0x0
  pushl $19
80105f78:	6a 13                	push   $0x13
  jmp alltraps
80105f7a:	e9 a0 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f7f:	6a 00                	push   $0x0
  pushl $20
80105f81:	6a 14                	push   $0x14
  jmp alltraps
80105f83:	e9 97 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f88:	6a 00                	push   $0x0
  pushl $21
80105f8a:	6a 15                	push   $0x15
  jmp alltraps
80105f8c:	e9 8e fa ff ff       	jmp    80105a1f <alltraps>
...
80105f91:	6a 00                	push   $0x0
  pushl $22
80105f93:	6a 16                	push   $0x16
  jmp alltraps
80105f95:	e9 85 fa ff ff       	jmp    80105a1f <alltraps>
...
80105f9a:	6a 00                	push   $0x0
  pushl $23
80105f9c:	6a 17                	push   $0x17
  jmp alltraps
80105f9e:	e9 7c fa ff ff       	jmp    80105a1f <alltraps>
...
80105fa3:	6a 00                	push   $0x0
  pushl $24
80105fa5:	6a 18                	push   $0x18
  jmp alltraps
80105fa7:	e9 73 fa ff ff       	jmp    80105a1f <alltraps>
...
80105fac:	6a 00                	push   $0x0
  pushl $25
80105fae:	6a 19                	push   $0x19
  jmp alltraps
80105fb0:	e9 6a fa ff ff       	jmp    80105a1f <alltraps>
...
80105fb5:	6a 00                	push   $0x0
  pushl $26
80105fb7:	6a 1a                	push   $0x1a
  jmp alltraps
80105fb9:	e9 61 fa ff ff       	jmp    80105a1f <alltraps>
...
80105fbe:	6a 00                	push   $0x0
  pushl $27
80105fc0:	6a 1b                	push   $0x1b
  jmp alltraps
80105fc2:	e9 58 fa ff ff       	jmp    80105a1f <alltraps>
...
80105fc7:	6a 00                	push   $0x0
  pushl $28
80105fc9:	6a 1c                	push   $0x1c
  jmp alltraps
80105fcb:	e9 4f fa ff ff       	jmp    80105a1f <alltraps>
...
80105fd0:	6a 00                	push   $0x0
  pushl $29
80105fd2:	6a 1d                	push   $0x1d
  jmp alltraps
80105fd4:	e9 46 fa ff ff       	jmp    80105a1f <alltraps>
...
80105fd9:	6a 00                	push   $0x0
  pushl $30
80105fdb:	6a 1e                	push   $0x1e
  jmp alltraps
80105fdd:	e9 3d fa ff ff       	jmp    80105a1f <alltraps>
...
80105fe2:	6a 00                	push   $0x0
  pushl $31
80105fe4:	6a 1f                	push   $0x1f
  jmp alltraps
80105fe6:	e9 34 fa ff ff       	jmp    80105a1f <alltraps>
...
80105feb:	6a 00                	push   $0x0
  pushl $32
80105fed:	6a 20                	push   $0x20
  jmp alltraps
80105fef:	e9 2b fa ff ff       	jmp    80105a1f <alltraps>
...
80105ff4:	6a 00                	push   $0x0
  pushl $33
80105ff6:	6a 21                	push   $0x21
  jmp alltraps
80105ff8:	e9 22 fa ff ff       	jmp    80105a1f <alltraps>
...
80105ffd:	6a 00                	push   $0x0
  pushl $34
80105fff:	6a 22                	push   $0x22
  jmp alltraps
80106001:	e9 19 fa ff ff       	jmp    80105a1f <alltraps>
...
80106006:	6a 00                	push   $0x0
  pushl $35
80106008:	6a 23                	push   $0x23
  jmp alltraps
8010600a:	e9 10 fa ff ff       	jmp    80105a1f <alltraps>
...
8010600f:	6a 00                	push   $0x0
  pushl $36
80106011:	6a 24                	push   $0x24
  jmp alltraps
80106013:	e9 07 fa ff ff       	jmp    80105a1f <alltraps>
...
80106018:	6a 00                	push   $0x0
  pushl $37
8010601a:	6a 25                	push   $0x25
  jmp alltraps
8010601c:	e9 fe f9 ff ff       	jmp    80105a1f <alltraps>
...
80106021:	6a 00                	push   $0x0
  pushl $38
80106023:	6a 26                	push   $0x26
  jmp alltraps
80106025:	e9 f5 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010602a:	6a 00                	push   $0x0
  pushl $39
8010602c:	6a 27                	push   $0x27
  jmp alltraps
8010602e:	e9 ec f9 ff ff       	jmp    80105a1f <alltraps>
...
80106033:	6a 00                	push   $0x0
  pushl $40
80106035:	6a 28                	push   $0x28
  jmp alltraps
80106037:	e9 e3 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010603c:	6a 00                	push   $0x0
  pushl $41
8010603e:	6a 29                	push   $0x29
  jmp alltraps
80106040:	e9 da f9 ff ff       	jmp    80105a1f <alltraps>
...
80106045:	6a 00                	push   $0x0
  pushl $42
80106047:	6a 2a                	push   $0x2a
  jmp alltraps
80106049:	e9 d1 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010604e:	6a 00                	push   $0x0
  pushl $43
80106050:	6a 2b                	push   $0x2b
  jmp alltraps
80106052:	e9 c8 f9 ff ff       	jmp    80105a1f <alltraps>
...
80106057:	6a 00                	push   $0x0
  pushl $44
80106059:	6a 2c                	push   $0x2c
  jmp alltraps
8010605b:	e9 bf f9 ff ff       	jmp    80105a1f <alltraps>
...
80106060:	6a 00                	push   $0x0
  pushl $45
80106062:	6a 2d                	push   $0x2d
  jmp alltraps
80106064:	e9 b6 f9 ff ff       	jmp    80105a1f <alltraps>
...
80106069:	6a 00                	push   $0x0
  pushl $46
8010606b:	6a 2e                	push   $0x2e
  jmp alltraps
8010606d:	e9 ad f9 ff ff       	jmp    80105a1f <alltraps>
...
80106072:	6a 00                	push   $0x0
  pushl $47
80106074:	6a 2f                	push   $0x2f
  jmp alltraps
80106076:	e9 a4 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010607b:	6a 00                	push   $0x0
  pushl $48
8010607d:	6a 30                	push   $0x30
  jmp alltraps
8010607f:	e9 9b f9 ff ff       	jmp    80105a1f <alltraps>
...
80106084:	6a 00                	push   $0x0
  pushl $49
80106086:	6a 31                	push   $0x31
  jmp alltraps
80106088:	e9 92 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010608d:	6a 00                	push   $0x0
  pushl $50
8010608f:	6a 32                	push   $0x32
  jmp alltraps
80106091:	e9 89 f9 ff ff       	jmp    80105a1f <alltraps>
...
80106096:	6a 00                	push   $0x0
  pushl $51
80106098:	6a 33                	push   $0x33
  jmp alltraps
8010609a:	e9 80 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010609f:	6a 00                	push   $0x0
  pushl $52
801060a1:	6a 34                	push   $0x34
  jmp alltraps
801060a3:	e9 77 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060a8:	6a 00                	push   $0x0
  pushl $53
801060aa:	6a 35                	push   $0x35
  jmp alltraps
801060ac:	e9 6e f9 ff ff       	jmp    80105a1f <alltraps>
...
801060b1:	6a 00                	push   $0x0
  pushl $54
801060b3:	6a 36                	push   $0x36
  jmp alltraps
801060b5:	e9 65 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060ba:	6a 00                	push   $0x0
  pushl $55
801060bc:	6a 37                	push   $0x37
  jmp alltraps
801060be:	e9 5c f9 ff ff       	jmp    80105a1f <alltraps>
...
801060c3:	6a 00                	push   $0x0
  pushl $56
801060c5:	6a 38                	push   $0x38
  jmp alltraps
801060c7:	e9 53 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060cc:	6a 00                	push   $0x0
  pushl $57
801060ce:	6a 39                	push   $0x39
  jmp alltraps
801060d0:	e9 4a f9 ff ff       	jmp    80105a1f <alltraps>
...
801060d5:	6a 00                	push   $0x0
  pushl $58
801060d7:	6a 3a                	push   $0x3a
  jmp alltraps
801060d9:	e9 41 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060de:	6a 00                	push   $0x0
  pushl $59
801060e0:	6a 3b                	push   $0x3b
  jmp alltraps
801060e2:	e9 38 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060e7:	6a 00                	push   $0x0
  pushl $60
801060e9:	6a 3c                	push   $0x3c
  jmp alltraps
801060eb:	e9 2f f9 ff ff       	jmp    80105a1f <alltraps>
...
801060f0:	6a 00                	push   $0x0
  pushl $61
801060f2:	6a 3d                	push   $0x3d
  jmp alltraps
801060f4:	e9 26 f9 ff ff       	jmp    80105a1f <alltraps>
...
801060f9:	6a 00                	push   $0x0
  pushl $62
801060fb:	6a 3e                	push   $0x3e
  jmp alltraps
801060fd:	e9 1d f9 ff ff       	jmp    80105a1f <alltraps>
...
80106102:	6a 00                	push   $0x0
  pushl $63
80106104:	6a 3f                	push   $0x3f
  jmp alltraps
80106106:	e9 14 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010610b:	6a 00                	push   $0x0
  pushl $64
8010610d:	6a 40                	push   $0x40
  jmp alltraps
8010610f:	e9 0b f9 ff ff       	jmp    80105a1f <alltraps>
...
80106114:	6a 00                	push   $0x0
  pushl $65
80106116:	6a 41                	push   $0x41
  jmp alltraps
80106118:	e9 02 f9 ff ff       	jmp    80105a1f <alltraps>
...
8010611d:	6a 00                	push   $0x0
  pushl $66
8010611f:	6a 42                	push   $0x42
  jmp alltraps
80106121:	e9 f9 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106126:	6a 00                	push   $0x0
  pushl $67
80106128:	6a 43                	push   $0x43
  jmp alltraps
8010612a:	e9 f0 f8 ff ff       	jmp    80105a1f <alltraps>
...
8010612f:	6a 00                	push   $0x0
  pushl $68
80106131:	6a 44                	push   $0x44
  jmp alltraps
80106133:	e9 e7 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106138:	6a 00                	push   $0x0
  pushl $69
8010613a:	6a 45                	push   $0x45
  jmp alltraps
8010613c:	e9 de f8 ff ff       	jmp    80105a1f <alltraps>
...
80106141:	6a 00                	push   $0x0
  pushl $70
80106143:	6a 46                	push   $0x46
  jmp alltraps
80106145:	e9 d5 f8 ff ff       	jmp    80105a1f <alltraps>
...
8010614a:	6a 00                	push   $0x0
  pushl $71
8010614c:	6a 47                	push   $0x47
  jmp alltraps
8010614e:	e9 cc f8 ff ff       	jmp    80105a1f <alltraps>
...
80106153:	6a 00                	push   $0x0
  pushl $72
80106155:	6a 48                	push   $0x48
  jmp alltraps
80106157:	e9 c3 f8 ff ff       	jmp    80105a1f <alltraps>
...
8010615c:	6a 00                	push   $0x0
  pushl $73
8010615e:	6a 49                	push   $0x49
  jmp alltraps
80106160:	e9 ba f8 ff ff       	jmp    80105a1f <alltraps>
...
80106165:	6a 00                	push   $0x0
  pushl $74
80106167:	6a 4a                	push   $0x4a
  jmp alltraps
80106169:	e9 b1 f8 ff ff       	jmp    80105a1f <alltraps>
...
8010616e:	6a 00                	push   $0x0
  pushl $75
80106170:	6a 4b                	push   $0x4b
  jmp alltraps
80106172:	e9 a8 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106177:	6a 00                	push   $0x0
  pushl $76
80106179:	6a 4c                	push   $0x4c
  jmp alltraps
8010617b:	e9 9f f8 ff ff       	jmp    80105a1f <alltraps>
...
80106180:	6a 00                	push   $0x0
  pushl $77
80106182:	6a 4d                	push   $0x4d
  jmp alltraps
80106184:	e9 96 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106189:	6a 00                	push   $0x0
  pushl $78
8010618b:	6a 4e                	push   $0x4e
  jmp alltraps
8010618d:	e9 8d f8 ff ff       	jmp    80105a1f <alltraps>
...
80106192:	6a 00                	push   $0x0
  pushl $79
80106194:	6a 4f                	push   $0x4f
  jmp alltraps
80106196:	e9 84 f8 ff ff       	jmp    80105a1f <alltraps>
...
8010619b:	6a 00                	push   $0x0
  pushl $80
8010619d:	6a 50                	push   $0x50
  jmp alltraps
8010619f:	e9 7b f8 ff ff       	jmp    80105a1f <alltraps>
...
801061a4:	6a 00                	push   $0x0
  pushl $81
801061a6:	6a 51                	push   $0x51
  jmp alltraps
801061a8:	e9 72 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061ad:	6a 00                	push   $0x0
  pushl $82
801061af:	6a 52                	push   $0x52
  jmp alltraps
801061b1:	e9 69 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061b6:	6a 00                	push   $0x0
  pushl $83
801061b8:	6a 53                	push   $0x53
  jmp alltraps
801061ba:	e9 60 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061bf:	6a 00                	push   $0x0
  pushl $84
801061c1:	6a 54                	push   $0x54
  jmp alltraps
801061c3:	e9 57 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061c8:	6a 00                	push   $0x0
  pushl $85
801061ca:	6a 55                	push   $0x55
  jmp alltraps
801061cc:	e9 4e f8 ff ff       	jmp    80105a1f <alltraps>
...
801061d1:	6a 00                	push   $0x0
  pushl $86
801061d3:	6a 56                	push   $0x56
  jmp alltraps
801061d5:	e9 45 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061da:	6a 00                	push   $0x0
  pushl $87
801061dc:	6a 57                	push   $0x57
  jmp alltraps
801061de:	e9 3c f8 ff ff       	jmp    80105a1f <alltraps>
...
801061e3:	6a 00                	push   $0x0
  pushl $88
801061e5:	6a 58                	push   $0x58
  jmp alltraps
801061e7:	e9 33 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061ec:	6a 00                	push   $0x0
  pushl $89
801061ee:	6a 59                	push   $0x59
  jmp alltraps
801061f0:	e9 2a f8 ff ff       	jmp    80105a1f <alltraps>
...
801061f5:	6a 00                	push   $0x0
  pushl $90
801061f7:	6a 5a                	push   $0x5a
  jmp alltraps
801061f9:	e9 21 f8 ff ff       	jmp    80105a1f <alltraps>
...
801061fe:	6a 00                	push   $0x0
  pushl $91
80106200:	6a 5b                	push   $0x5b
  jmp alltraps
80106202:	e9 18 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106207:	6a 00                	push   $0x0
  pushl $92
80106209:	6a 5c                	push   $0x5c
  jmp alltraps
8010620b:	e9 0f f8 ff ff       	jmp    80105a1f <alltraps>
...
80106210:	6a 00                	push   $0x0
  pushl $93
80106212:	6a 5d                	push   $0x5d
  jmp alltraps
80106214:	e9 06 f8 ff ff       	jmp    80105a1f <alltraps>
...
80106219:	6a 00                	push   $0x0
  pushl $94
8010621b:	6a 5e                	push   $0x5e
  jmp alltraps
8010621d:	e9 fd f7 ff ff       	jmp    80105a1f <alltraps>
...
80106222:	6a 00                	push   $0x0
  pushl $95
80106224:	6a 5f                	push   $0x5f
  jmp alltraps
80106226:	e9 f4 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010622b:	6a 00                	push   $0x0
  pushl $96
8010622d:	6a 60                	push   $0x60
  jmp alltraps
8010622f:	e9 eb f7 ff ff       	jmp    80105a1f <alltraps>
...
80106234:	6a 00                	push   $0x0
  pushl $97
80106236:	6a 61                	push   $0x61
  jmp alltraps
80106238:	e9 e2 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010623d:	6a 00                	push   $0x0
  pushl $98
8010623f:	6a 62                	push   $0x62
  jmp alltraps
80106241:	e9 d9 f7 ff ff       	jmp    80105a1f <alltraps>
...
80106246:	6a 00                	push   $0x0
  pushl $99
80106248:	6a 63                	push   $0x63
  jmp alltraps
8010624a:	e9 d0 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010624f:	6a 00                	push   $0x0
  pushl $100
80106251:	6a 64                	push   $0x64
  jmp alltraps
80106253:	e9 c7 f7 ff ff       	jmp    80105a1f <alltraps>
...
80106258:	6a 00                	push   $0x0
  pushl $101
8010625a:	6a 65                	push   $0x65
  jmp alltraps
8010625c:	e9 be f7 ff ff       	jmp    80105a1f <alltraps>
...
80106261:	6a 00                	push   $0x0
  pushl $102
80106263:	6a 66                	push   $0x66
  jmp alltraps
80106265:	e9 b5 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010626a:	6a 00                	push   $0x0
  pushl $103
8010626c:	6a 67                	push   $0x67
  jmp alltraps
8010626e:	e9 ac f7 ff ff       	jmp    80105a1f <alltraps>
...
80106273:	6a 00                	push   $0x0
  pushl $104
80106275:	6a 68                	push   $0x68
  jmp alltraps
80106277:	e9 a3 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010627c:	6a 00                	push   $0x0
  pushl $105
8010627e:	6a 69                	push   $0x69
  jmp alltraps
80106280:	e9 9a f7 ff ff       	jmp    80105a1f <alltraps>
...
80106285:	6a 00                	push   $0x0
  pushl $106
80106287:	6a 6a                	push   $0x6a
  jmp alltraps
80106289:	e9 91 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010628e:	6a 00                	push   $0x0
  pushl $107
80106290:	6a 6b                	push   $0x6b
  jmp alltraps
80106292:	e9 88 f7 ff ff       	jmp    80105a1f <alltraps>
...
80106297:	6a 00                	push   $0x0
  pushl $108
80106299:	6a 6c                	push   $0x6c
  jmp alltraps
8010629b:	e9 7f f7 ff ff       	jmp    80105a1f <alltraps>
...
801062a0:	6a 00                	push   $0x0
  pushl $109
801062a2:	6a 6d                	push   $0x6d
  jmp alltraps
801062a4:	e9 76 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062a9:	6a 00                	push   $0x0
  pushl $110
801062ab:	6a 6e                	push   $0x6e
  jmp alltraps
801062ad:	e9 6d f7 ff ff       	jmp    80105a1f <alltraps>
...
801062b2:	6a 00                	push   $0x0
  pushl $111
801062b4:	6a 6f                	push   $0x6f
  jmp alltraps
801062b6:	e9 64 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062bb:	6a 00                	push   $0x0
  pushl $112
801062bd:	6a 70                	push   $0x70
  jmp alltraps
801062bf:	e9 5b f7 ff ff       	jmp    80105a1f <alltraps>
...
801062c4:	6a 00                	push   $0x0
  pushl $113
801062c6:	6a 71                	push   $0x71
  jmp alltraps
801062c8:	e9 52 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062cd:	6a 00                	push   $0x0
  pushl $114
801062cf:	6a 72                	push   $0x72
  jmp alltraps
801062d1:	e9 49 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062d6:	6a 00                	push   $0x0
  pushl $115
801062d8:	6a 73                	push   $0x73
  jmp alltraps
801062da:	e9 40 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062df:	6a 00                	push   $0x0
  pushl $116
801062e1:	6a 74                	push   $0x74
  jmp alltraps
801062e3:	e9 37 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062e8:	6a 00                	push   $0x0
  pushl $117
801062ea:	6a 75                	push   $0x75
  jmp alltraps
801062ec:	e9 2e f7 ff ff       	jmp    80105a1f <alltraps>
...
801062f1:	6a 00                	push   $0x0
  pushl $118
801062f3:	6a 76                	push   $0x76
  jmp alltraps
801062f5:	e9 25 f7 ff ff       	jmp    80105a1f <alltraps>
...
801062fa:	6a 00                	push   $0x0
  pushl $119
801062fc:	6a 77                	push   $0x77
  jmp alltraps
801062fe:	e9 1c f7 ff ff       	jmp    80105a1f <alltraps>
...
80106303:	6a 00                	push   $0x0
  pushl $120
80106305:	6a 78                	push   $0x78
  jmp alltraps
80106307:	e9 13 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010630c:	6a 00                	push   $0x0
  pushl $121
8010630e:	6a 79                	push   $0x79
  jmp alltraps
80106310:	e9 0a f7 ff ff       	jmp    80105a1f <alltraps>
...
80106315:	6a 00                	push   $0x0
  pushl $122
80106317:	6a 7a                	push   $0x7a
  jmp alltraps
80106319:	e9 01 f7 ff ff       	jmp    80105a1f <alltraps>
...
8010631e:	6a 00                	push   $0x0
  pushl $123
80106320:	6a 7b                	push   $0x7b
  jmp alltraps
80106322:	e9 f8 f6 ff ff       	jmp    80105a1f <alltraps>
...
80106327:	6a 00                	push   $0x0
  pushl $124
80106329:	6a 7c                	push   $0x7c
  jmp alltraps
8010632b:	e9 ef f6 ff ff       	jmp    80105a1f <alltraps>
...
80106330:	6a 00                	push   $0x0
  pushl $125
80106332:	6a 7d                	push   $0x7d
  jmp alltraps
80106334:	e9 e6 f6 ff ff       	jmp    80105a1f <alltraps>
...
80106339:	6a 00                	push   $0x0
  pushl $126
8010633b:	6a 7e                	push   $0x7e
  jmp alltraps
8010633d:	e9 dd f6 ff ff       	jmp    80105a1f <alltraps>
...
80106342:	6a 00                	push   $0x0
  pushl $127
80106344:	6a 7f                	push   $0x7f
  jmp alltraps
80106346:	e9 d4 f6 ff ff       	jmp    80105a1f <alltraps>
...
8010634d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106352:	e9 c8 f6 ff ff       	jmp    80105a1f <alltraps>
...
80106357:	6a 00                	push   $0x0
  pushl $129
80106359:	68 81 00 00 00       	push   $0x81
  jmp alltraps
...
80106363:	6a 00                	push   $0x0
  pushl $130
80106365:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010636a:	e9 b0 f6 ff ff       	jmp    80105a1f <alltraps>
...
8010636f:	6a 00                	push   $0x0
  pushl $131
80106371:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106376:	e9 a4 f6 ff ff       	jmp    80105a1f <alltraps>
...
8010637b:	6a 00                	push   $0x0
  pushl $132
8010637d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
...
80106387:	6a 00                	push   $0x0
  pushl $133
80106389:	68 85 00 00 00       	push   $0x85
  jmp alltraps
...
80106393:	6a 00                	push   $0x0
  pushl $134
80106395:	68 86 00 00 00       	push   $0x86
  jmp alltraps
...
8010639f:	6a 00                	push   $0x0
  pushl $135
801063a1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
...
801063ab:	6a 00                	push   $0x0
  pushl $136
801063ad:	68 88 00 00 00       	push   $0x88
  jmp alltraps
...
801063b7:	6a 00                	push   $0x0
  pushl $137
801063b9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
...
801063c3:	6a 00                	push   $0x0
  pushl $138
801063c5:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
...
801063cf:	6a 00                	push   $0x0
  pushl $139
801063d1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
...
801063db:	6a 00                	push   $0x0
  pushl $140
801063dd:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
...
801063e7:	6a 00                	push   $0x0
  pushl $141
801063e9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
...
801063f3:	6a 00                	push   $0x0
  pushl $142
801063f5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
...
801063ff:	6a 00                	push   $0x0
  pushl $143
80106401:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
...
8010640b:	6a 00                	push   $0x0
  pushl $144
8010640d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
...
80106417:	6a 00                	push   $0x0
  pushl $145
80106419:	68 91 00 00 00       	push   $0x91
  jmp alltraps
...
80106423:	6a 00                	push   $0x0
  pushl $146
80106425:	68 92 00 00 00       	push   $0x92
  jmp alltraps
...
8010642f:	6a 00                	push   $0x0
  pushl $147
80106431:	68 93 00 00 00       	push   $0x93
  jmp alltraps
...
8010643b:	6a 00                	push   $0x0
  pushl $148
8010643d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
...
80106447:	6a 00                	push   $0x0
  pushl $149
80106449:	68 95 00 00 00       	push   $0x95
  jmp alltraps
...
80106453:	6a 00                	push   $0x0
  pushl $150
80106455:	68 96 00 00 00       	push   $0x96
  jmp alltraps
...
8010645f:	6a 00                	push   $0x0
  pushl $151
80106461:	68 97 00 00 00       	push   $0x97
  jmp alltraps
...
8010646b:	6a 00                	push   $0x0
  pushl $152
8010646d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
...
80106477:	6a 00                	push   $0x0
  pushl $153
80106479:	68 99 00 00 00       	push   $0x99
  jmp alltraps
...
80106483:	6a 00                	push   $0x0
  pushl $154
80106485:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
...
8010648f:	6a 00                	push   $0x0
  pushl $155
80106491:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
...
8010649b:	6a 00                	push   $0x0
  pushl $156
8010649d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
...
801064a7:	6a 00                	push   $0x0
  pushl $157
801064a9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
...
801064b3:	6a 00                	push   $0x0
  pushl $158
801064b5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
...
801064bf:	6a 00                	push   $0x0
  pushl $159
801064c1:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
...
801064cb:	6a 00                	push   $0x0
  pushl $160
801064cd:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
...
801064d7:	6a 00                	push   $0x0
  pushl $161
801064d9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
...
801064e3:	6a 00                	push   $0x0
  pushl $162
801064e5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
...
801064ef:	6a 00                	push   $0x0
  pushl $163
801064f1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
...
801064fb:	6a 00                	push   $0x0
  pushl $164
801064fd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
...
80106507:	6a 00                	push   $0x0
  pushl $165
80106509:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
...
80106513:	6a 00                	push   $0x0
  pushl $166
80106515:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
...
8010651f:	6a 00                	push   $0x0
  pushl $167
80106521:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
...
8010652b:	6a 00                	push   $0x0
  pushl $168
8010652d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
...
80106537:	6a 00                	push   $0x0
  pushl $169
80106539:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
...
80106543:	6a 00                	push   $0x0
  pushl $170
80106545:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
...
8010654f:	6a 00                	push   $0x0
  pushl $171
80106551:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
...
8010655b:	6a 00                	push   $0x0
  pushl $172
8010655d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
...
80106567:	6a 00                	push   $0x0
  pushl $173
80106569:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
...
80106573:	6a 00                	push   $0x0
  pushl $174
80106575:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
...
8010657f:	6a 00                	push   $0x0
  pushl $175
80106581:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
...
8010658b:	6a 00                	push   $0x0
  pushl $176
8010658d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
...
80106597:	6a 00                	push   $0x0
  pushl $177
80106599:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
...
801065a3:	6a 00                	push   $0x0
  pushl $178
801065a5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
...
801065af:	6a 00                	push   $0x0
  pushl $179
801065b1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
...
801065bb:	6a 00                	push   $0x0
  pushl $180
801065bd:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
...
801065c7:	6a 00                	push   $0x0
  pushl $181
801065c9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
...
801065d3:	6a 00                	push   $0x0
  pushl $182
801065d5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
...
801065df:	6a 00                	push   $0x0
  pushl $183
801065e1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
...
801065eb:	6a 00                	push   $0x0
  pushl $184
801065ed:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
...
801065f7:	6a 00                	push   $0x0
  pushl $185
801065f9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
...
80106603:	6a 00                	push   $0x0
  pushl $186
80106605:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
...
8010660f:	6a 00                	push   $0x0
  pushl $187
80106611:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
...
8010661b:	6a 00                	push   $0x0
  pushl $188
8010661d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
...
80106627:	6a 00                	push   $0x0
  pushl $189
80106629:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
...
80106633:	6a 00                	push   $0x0
  pushl $190
80106635:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
...
8010663f:	6a 00                	push   $0x0
  pushl $191
80106641:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
...
8010664b:	6a 00                	push   $0x0
  pushl $192
8010664d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
...
80106657:	6a 00                	push   $0x0
  pushl $193
80106659:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
...
80106663:	6a 00                	push   $0x0
  pushl $194
80106665:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
...
8010666f:	6a 00                	push   $0x0
  pushl $195
80106671:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
...
8010667b:	6a 00                	push   $0x0
  pushl $196
8010667d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
...
80106687:	6a 00                	push   $0x0
  pushl $197
80106689:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
...
80106693:	6a 00                	push   $0x0
  pushl $198
80106695:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
...
8010669f:	6a 00                	push   $0x0
  pushl $199
801066a1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
...
801066ab:	6a 00                	push   $0x0
  pushl $200
801066ad:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
...
801066b7:	6a 00                	push   $0x0
  pushl $201
801066b9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
...
801066c3:	6a 00                	push   $0x0
  pushl $202
801066c5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
...
801066cf:	6a 00                	push   $0x0
  pushl $203
801066d1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
...
801066db:	6a 00                	push   $0x0
  pushl $204
801066dd:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
...
801066e7:	6a 00                	push   $0x0
  pushl $205
801066e9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
...
801066f3:	6a 00                	push   $0x0
  pushl $206
801066f5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
...
801066ff:	6a 00                	push   $0x0
  pushl $207
80106701:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
...
8010670b:	6a 00                	push   $0x0
  pushl $208
8010670d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
...
80106717:	6a 00                	push   $0x0
  pushl $209
80106719:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
...
80106723:	6a 00                	push   $0x0
  pushl $210
80106725:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
...
8010672f:	6a 00                	push   $0x0
  pushl $211
80106731:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
...
8010673b:	6a 00                	push   $0x0
  pushl $212
8010673d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
...
80106747:	6a 00                	push   $0x0
  pushl $213
80106749:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
...
80106753:	6a 00                	push   $0x0
  pushl $214
80106755:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
...
8010675f:	6a 00                	push   $0x0
  pushl $215
80106761:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
...
8010676b:	6a 00                	push   $0x0
  pushl $216
8010676d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
...
80106777:	6a 00                	push   $0x0
  pushl $217
80106779:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
...
80106783:	6a 00                	push   $0x0
  pushl $218
80106785:	68 da 00 00 00       	push   $0xda
  jmp alltraps
...
8010678f:	6a 00                	push   $0x0
  pushl $219
80106791:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
...
8010679b:	6a 00                	push   $0x0
  pushl $220
8010679d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
...
801067a7:	6a 00                	push   $0x0
  pushl $221
801067a9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
...
801067b3:	6a 00                	push   $0x0
  pushl $222
801067b5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
...
801067bf:	6a 00                	push   $0x0
  pushl $223
801067c1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
...
801067cb:	6a 00                	push   $0x0
  pushl $224
801067cd:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
...
801067d7:	6a 00                	push   $0x0
  pushl $225
801067d9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
...
801067e3:	6a 00                	push   $0x0
  pushl $226
801067e5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
...
801067ef:	6a 00                	push   $0x0
  pushl $227
801067f1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
...
801067fb:	6a 00                	push   $0x0
  pushl $228
801067fd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
...
80106807:	6a 00                	push   $0x0
  pushl $229
80106809:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
...
80106813:	6a 00                	push   $0x0
  pushl $230
80106815:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
...
8010681f:	6a 00                	push   $0x0
  pushl $231
80106821:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
...
8010682b:	6a 00                	push   $0x0
  pushl $232
8010682d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
...
80106837:	6a 00                	push   $0x0
  pushl $233
80106839:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
...
80106843:	6a 00                	push   $0x0
  pushl $234
80106845:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
...
8010684f:	6a 00                	push   $0x0
  pushl $235
80106851:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
...
8010685b:	6a 00                	push   $0x0
  pushl $236
8010685d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
...
80106867:	6a 00                	push   $0x0
  pushl $237
80106869:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
...
80106873:	6a 00                	push   $0x0
  pushl $238
80106875:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
...
8010687f:	6a 00                	push   $0x0
  pushl $239
80106881:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
...
8010688b:	6a 00                	push   $0x0
  pushl $240
8010688d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
...
80106897:	6a 00                	push   $0x0
  pushl $241
80106899:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
...
801068a3:	6a 00                	push   $0x0
  pushl $242
801068a5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
...
801068af:	6a 00                	push   $0x0
  pushl $243
801068b1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
...
801068bb:	6a 00                	push   $0x0
  pushl $244
801068bd:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
...
801068c7:	6a 00                	push   $0x0
  pushl $245
801068c9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
...
801068d3:	6a 00                	push   $0x0
  pushl $246
801068d5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
...
801068df:	6a 00                	push   $0x0
  pushl $247
801068e1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
...
801068eb:	6a 00                	push   $0x0
  pushl $248
801068ed:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
...
801068f7:	6a 00                	push   $0x0
  pushl $249
801068f9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
...
80106903:	6a 00                	push   $0x0
  pushl $250
80106905:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
...
8010690f:	6a 00                	push   $0x0
  pushl $251
80106911:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
...
8010691b:	6a 00                	push   $0x0
  pushl $252
8010691d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
...
80106927:	6a 00                	push   $0x0
  pushl $253
80106929:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
...
80106933:	6a 00                	push   $0x0
  pushl $254
80106935:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
...
8010693f:	6a 00                	push   $0x0
  pushl $255
80106941:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
...
80106955:	89 d6                	mov    %edx,%esi
  ...
  pde = &pgdir[PDX(va)];
80106957:	c1 ea 16             	shr    $0x16,%edx
{
...
8010695e:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
80106961:	8b 1f                	mov    (%edi),%ebx
80106963:	f6 c3 01             	test   $0x1,%bl
80106966:	74 28                	je     80106990 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106968:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
8010696e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
...
80106976:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
80106979:	c1 e8 0a             	shr    $0xa,%eax
8010697c:	25 fc 0f 00 00       	and    $0xffc,%eax
80106981:	01 d8                	add    %ebx,%eax
}
80106983:	5b                   	pop    %ebx
80106984:	5e                   	pop    %esi
80106985:	5f                   	pop    %edi
...
80106994:	e8 97 bc ff ff       	call   80102630 <kalloc>
80106999:	89 c3                	mov    %eax,%ebx
...
801069aa:	e8 f1 dd ff ff       	call   801047a0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801069d6:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
{
801069da:	56                   	push   %esi
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801069db:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
801069e0:	89 d6                	mov    %edx,%esi
{
801069e2:	53                   	push   %ebx
  a = (char*)PGROUNDDOWN((uint)va);
801069e3:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
{
801069e9:	83 ec 1c             	sub    $0x1c,%esp
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801069ec:	89 45 e0             	mov    %eax,-0x20(%ebp)
801069ef:	8b 45 08             	mov    0x8(%ebp),%eax
801069f2:	29 f0                	sub    %esi,%eax
801069f4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801069f7:	eb 1f                	jmp    80106a18 <mappages+0x48>
...
80106a03:	75 45                	jne    80106a4a <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106a05:	0b 5d 0c             	or     0xc(%ebp),%ebx
80106a08:	83 cb 01             	or     $0x1,%ebx
80106a0b:	89 18                	mov    %ebx,(%eax)
    if(a == last)
80106a0d:	3b 75 e0             	cmp    -0x20(%ebp),%esi
80106a10:	74 2e                	je     80106a40 <mappages+0x70>
      break;
    a += PGSIZE;
80106a12:	81 c6 00 10 00 00    	add    $0x1000,%esi
  for(;;){
80106a18:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106a1b:	b9 01 00 00 00       	mov    $0x1,%ecx
80106a20:	89 f2                	mov    %esi,%edx
80106a22:	8d 1c 06             	lea    (%esi,%eax,1),%ebx
80106a25:	89 f8                	mov    %edi,%eax
80106a27:	e8 24 ff ff ff       	call   80106950 <walkpgdir>
80106a2c:	85 c0                	test   %eax,%eax
80106a2e:	75 d0                	jne    80106a00 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
...
80106a4d:	68 30 7d 10 80       	push   $0x80107d30
...
80106a68:	89 d3                	mov    %edx,%ebx
  ...
  a = PGROUNDUP(newsz);
80106a6a:	8d 91 ff 0f 00 00    	lea    0xfff(%ecx),%edx
80106a70:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106a76:	83 ec 1c             	sub    $0x1c,%esp
80106a79:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106a7c:	39 da                	cmp    %ebx,%edx
80106a7e:	73 5b                	jae    80106adb <deallocuvm.part.0+0x7b>
80106a80:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
80106a83:	89 d7                	mov    %edx,%edi
80106a85:	eb 14                	jmp    80106a9b <deallocuvm.part.0+0x3b>
80106a87:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106a8e:	66 90                	xchg   %ax,%ax
80106a90:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106a96:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106a99:	76 40                	jbe    80106adb <deallocuvm.part.0+0x7b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106a9b:	31 c9                	xor    %ecx,%ecx
80106a9d:	89 fa                	mov    %edi,%edx
80106a9f:	89 f0                	mov    %esi,%eax
80106aa1:	e8 aa fe ff ff       	call   80106950 <walkpgdir>
80106aa6:	89 c3                	mov    %eax,%ebx
    if(!pte)
80106aa8:	85 c0                	test   %eax,%eax
80106aaa:	74 44                	je     80106af0 <deallocuvm.part.0+0x90>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106aac:	8b 00                	mov    (%eax),%eax
80106aae:	a8 01                	test   $0x1,%al
80106ab0:	74 de                	je     80106a90 <deallocuvm.part.0+0x30>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106ab2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106ab7:	74 47                	je     80106b00 <deallocuvm.part.0+0xa0>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
...
80106ac1:	81 c7 00 10 00 00    	add    $0x1000,%edi
      kfree(v);
80106ac7:	50                   	push   %eax
80106ac8:	e8 a3 b9 ff ff       	call   80102470 <kfree>
      *pte = 0;
80106acd:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80106ad3:	83 c4 10             	add    $0x10,%esp
  for(; a  < oldsz; a += PGSIZE){
80106ad6:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106ad9:	77 c0                	ja     80106a9b <deallocuvm.part.0+0x3b>
    }
  }
  return newsz;
}
...
80106af2:	81 e2 00 00 c0 ff    	and    $0xffc00000,%edx
80106af8:	8d ba 00 00 40 00    	lea    0x400000(%edx),%edi
80106afe:	eb 96                	jmp    80106a96 <deallocuvm.part.0+0x36>
        panic("kfree");
80106b00:	83 ec 0c             	sub    $0xc,%esp
80106b03:	68 e6 76 10 80       	push   $0x801076e6
...
80106b17:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b1a:	e8 41 ce ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
80106b1f:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106b24:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106b2a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106b2e:	c7 80 d8 31 11 80 ff 	movl   $0xffff,-0x7feece28(%eax)
80106b35:	ff 00 00 
80106b38:	c7 80 dc 31 11 80 00 	movl   $0xcf9a00,-0x7feece24(%eax)
80106b3f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b42:	c7 80 e0 31 11 80 ff 	movl   $0xffff,-0x7feece20(%eax)
80106b49:	ff 00 00 
80106b4c:	c7 80 e4 31 11 80 00 	movl   $0xcf9200,-0x7feece1c(%eax)
80106b53:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b56:	c7 80 e8 31 11 80 ff 	movl   $0xffff,-0x7feece18(%eax)
80106b5d:	ff 00 00 
80106b60:	c7 80 ec 31 11 80 00 	movl   $0xcffa00,-0x7feece14(%eax)
80106b67:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106b6a:	c7 80 f0 31 11 80 ff 	movl   $0xffff,-0x7feece10(%eax)
80106b71:	ff 00 00 
80106b74:	c7 80 f4 31 11 80 00 	movl   $0xcff200,-0x7feece0c(%eax)
80106b7b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106b7e:	05 d0 31 11 80       	add    $0x801131d0,%eax
  pd[1] = (uint)p;
...
80106ba4:	a1 84 60 11 80       	mov    0x80116084,%eax
80106ba9:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80106bcd:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80106bd0:	85 f6                	test   %esi,%esi
80106bd2:	0f 84 cb 00 00 00    	je     80106ca3 <switchuvm+0xe3>
  if(p->kstack == 0)
80106bd8:	8b 46 08             	mov    0x8(%esi),%eax
80106bdb:	85 c0                	test   %eax,%eax
80106bdd:	0f 84 da 00 00 00    	je     80106cbd <switchuvm+0xfd>
  if(p->pgdir == 0)
80106be3:	8b 46 04             	mov    0x4(%esi),%eax
80106be6:	85 c0                	test   %eax,%eax
80106be8:	0f 84 c2 00 00 00    	je     80106cb0 <switchuvm+0xf0>
  pushcli();
80106bee:	e8 9d d9 ff ff       	call   80104590 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106bf3:	e8 f8 cc ff ff       	call   801038f0 <mycpu>
80106bf8:	89 c3                	mov    %eax,%ebx
80106bfa:	e8 f1 cc ff ff       	call   801038f0 <mycpu>
80106bff:	89 c7                	mov    %eax,%edi
80106c01:	e8 ea cc ff ff       	call   801038f0 <mycpu>
80106c06:	83 c7 08             	add    $0x8,%edi
80106c09:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c0c:	e8 df cc ff ff       	call   801038f0 <mycpu>
80106c11:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106c14:	ba 67 00 00 00       	mov    $0x67,%edx
80106c19:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106c20:	83 c0 08             	add    $0x8,%eax
80106c23:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c2a:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c2f:	83 c1 08             	add    $0x8,%ecx
80106c32:	c1 e8 18             	shr    $0x18,%eax
80106c35:	c1 e9 10             	shr    $0x10,%ecx
80106c38:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106c3e:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106c44:	b9 99 40 00 00       	mov    $0x4099,%ecx
80106c49:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106c50:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106c55:	e8 96 cc ff ff       	call   801038f0 <mycpu>
80106c5a:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106c61:	e8 8a cc ff ff       	call   801038f0 <mycpu>
80106c66:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106c6a:	8b 5e 08             	mov    0x8(%esi),%ebx
80106c6d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c73:	e8 78 cc ff ff       	call   801038f0 <mycpu>
80106c78:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c7b:	e8 70 cc ff ff       	call   801038f0 <mycpu>
80106c80:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106c84:	b8 28 00 00 00       	mov    $0x28,%eax
80106c89:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106c8c:	8b 46 04             	mov    0x4(%esi),%eax
80106c8f:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106c94:	0f 22 d8             	mov    %eax,%cr3
}
...
80106c9d:	5d                   	pop    %ebp
  popcli();
80106c9e:	e9 3d d9 ff ff       	jmp    801045e0 <popcli>
    panic("switchuvm: no process");
80106ca3:	83 ec 0c             	sub    $0xc,%esp
80106ca6:	68 36 7d 10 80       	push   $0x80107d36
80106cab:	e8 e0 96 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80106cb0:	83 ec 0c             	sub    $0xc,%esp
80106cb3:	68 61 7d 10 80       	push   $0x80107d61
80106cb8:	e8 d3 96 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80106cbd:	83 ec 0c             	sub    $0xc,%esp
80106cc0:	68 4c 7d 10 80       	push   $0x80107d4c
80106cc5:	e8 c6 96 ff ff       	call   80100390 <panic>
...
80106ce0:	8b 75 10             	mov    0x10(%ebp),%esi
80106ce3:	8b 7d 08             	mov    0x8(%ebp),%edi
80106ce6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106ce9:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106cef:	77 4b                	ja     80106d3c <inituvm+0x6c>
  mem = kalloc();
80106cf1:	e8 3a b9 ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
80106cf6:	83 ec 04             	sub    $0x4,%esp
80106cf9:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
80106cfe:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106d00:	6a 00                	push   $0x0
80106d02:	50                   	push   %eax
80106d03:	e8 98 da ff ff       	call   801047a0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106d08:	58                   	pop    %eax
80106d09:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106d0f:	5a                   	pop    %edx
80106d10:	6a 06                	push   $0x6
80106d12:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106d17:	31 d2                	xor    %edx,%edx
80106d19:	50                   	push   %eax
80106d1a:	89 f8                	mov    %edi,%eax
80106d1c:	e8 af fc ff ff       	call   801069d0 <mappages>
  memmove(mem, init, sz);
80106d21:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106d24:	89 75 10             	mov    %esi,0x10(%ebp)
80106d27:	83 c4 10             	add    $0x10,%esp
80106d2a:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106d2d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106d36:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d37:	e9 04 db ff ff       	jmp    80104840 <memmove>
    panic("inituvm: more than a page");
80106d3c:	83 ec 0c             	sub    $0xc,%esp
80106d3f:	68 75 7d 10 80       	push   $0x80107d75
...
80106d60:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106d63:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106d68:	0f 85 99 00 00 00    	jne    80106e07 <loaduvm+0xb7>
  for(i = 0; i < sz; i += PGSIZE){
80106d6e:	01 f0                	add    %esi,%eax
80106d70:	89 f3                	mov    %esi,%ebx
80106d72:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106d75:	8b 45 14             	mov    0x14(%ebp),%eax
80106d78:	01 f0                	add    %esi,%eax
80106d7a:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106d7d:	85 f6                	test   %esi,%esi
80106d7f:	75 15                	jne    80106d96 <loaduvm+0x46>
80106d81:	eb 6d                	jmp    80106df0 <loaduvm+0xa0>
80106d83:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106d87:	90                   	nop
80106d88:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106d8e:	89 f0                	mov    %esi,%eax
80106d90:	29 d8                	sub    %ebx,%eax
80106d92:	39 c6                	cmp    %eax,%esi
80106d94:	76 5a                	jbe    80106df0 <loaduvm+0xa0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106d96:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106d99:	8b 45 08             	mov    0x8(%ebp),%eax
80106d9c:	31 c9                	xor    %ecx,%ecx
80106d9e:	29 da                	sub    %ebx,%edx
80106da0:	e8 ab fb ff ff       	call   80106950 <walkpgdir>
80106da5:	85 c0                	test   %eax,%eax
80106da7:	74 51                	je     80106dfa <loaduvm+0xaa>
    pa = PTE_ADDR(*pte);
...
80106dcb:	ff 75 10             	pushl  0x10(%ebp)
80106dce:	e8 8d ac ff ff       	call   80101a60 <readi>
80106dd3:	83 c4 10             	add    $0x10,%esp
80106dd6:	39 f8                	cmp    %edi,%eax
80106dd8:	74 ae                	je     80106d88 <loaduvm+0x38>
}
...
{
80106e30:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80106e33:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e36:	85 c0                	test   %eax,%eax
80106e38:	0f 88 b2 00 00 00    	js     80106ef0 <allocuvm+0xd0>
  if(newsz < oldsz)
80106e3e:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80106e41:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106e44:	0f 82 96 00 00 00    	jb     80106ee0 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106e4a:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106e50:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106e56:	39 75 10             	cmp    %esi,0x10(%ebp)
80106e59:	77 40                	ja     80106e9b <allocuvm+0x7b>
80106e5b:	e9 83 00 00 00       	jmp    80106ee3 <allocuvm+0xc3>
    memset(mem, 0, PGSIZE);
80106e60:	83 ec 04             	sub    $0x4,%esp
80106e63:	68 00 10 00 00       	push   $0x1000
80106e68:	6a 00                	push   $0x0
80106e6a:	50                   	push   %eax
80106e6b:	e8 30 d9 ff ff       	call   801047a0 <memset>
...
80106e84:	e8 47 fb ff ff       	call   801069d0 <mappages>
...
80106e99:	76 48                	jbe    80106ee3 <allocuvm+0xc3>
    mem = kalloc();
80106e9b:	e8 90 b7 ff ff       	call   80102630 <kalloc>
...
80106ea9:	68 ad 7d 10 80       	push   $0x80107dad
80106eae:	e8 fd 97 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106ec5:	e8 96 fb ff ff       	call   80106a60 <deallocuvm.part.0>
      return 0;
...
80106f0b:	68 c5 7d 10 80       	push   $0x80107dc5
80106f10:	e8 9b 97 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106f27:	e8 34 fb ff ff       	call   80106a60 <deallocuvm.part.0>
      kfree(mem);
80106f2c:	83 ec 0c             	sub    $0xc,%esp
80106f2f:	53                   	push   %ebx
80106f30:	e8 3b b5 ff ff       	call   80102470 <kfree>
      return 0;
...
80106f57:	8b 55 0c             	mov    0xc(%ebp),%edx
80106f5a:	8b 4d 10             	mov    0x10(%ebp),%ecx
80106f5d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
80106f60:	39 d1                	cmp    %edx,%ecx
80106f62:	73 0c                	jae    80106f70 <deallocuvm+0x20>
}
80106f64:	5d                   	pop    %ebp
80106f65:	e9 f6 fa ff ff       	jmp    80106a60 <deallocuvm.part.0>
...
80106f92:	74 55                	je     80106fe9 <freevm+0x69>
  if(newsz >= oldsz)
80106f94:	31 c9                	xor    %ecx,%ecx
80106f96:	ba 00 00 00 80       	mov    $0x80000000,%edx
80106f9b:	89 f0                	mov    %esi,%eax
80106f9d:	89 f3                	mov    %esi,%ebx
80106f9f:	e8 bc fa ff ff       	call   80106a60 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106fa4:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80106faa:	eb 0b                	jmp    80106fb7 <freevm+0x37>
...
80106fce:	e8 9d b4 ff ff       	call   80102470 <kfree>
...
80106fe3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106fe4:	e9 87 b4 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
80106fe9:	83 ec 0c             	sub    $0xc,%esp
80106fec:	68 e1 7d 10 80       	push   $0x80107de1
...
80107009:	e8 22 b6 ff ff       	call   80102630 <kalloc>
8010700e:	89 c6                	mov    %eax,%esi
80107010:	85 c0                	test   %eax,%eax
80107012:	74 42                	je     80107056 <setupkvm+0x56>
  memset(pgdir, 0, PGSIZE);
80107014:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107017:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
8010701c:	68 00 10 00 00       	push   $0x1000
80107021:	6a 00                	push   $0x0
80107023:	50                   	push   %eax
80107024:	e8 77 d7 ff ff       	call   801047a0 <memset>
80107029:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
8010702c:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010702f:	83 ec 08             	sub    $0x8,%esp
80107032:	8b 4b 08             	mov    0x8(%ebx),%ecx
80107035:	ff 73 0c             	pushl  0xc(%ebx)
80107038:	8b 13                	mov    (%ebx),%edx
8010703a:	50                   	push   %eax
8010703b:	29 c1                	sub    %eax,%ecx
8010703d:	89 f0                	mov    %esi,%eax
8010703f:	e8 8c f9 ff ff       	call   801069d0 <mappages>
80107044:	83 c4 10             	add    $0x10,%esp
80107047:	85 c0                	test   %eax,%eax
80107049:	78 15                	js     80107060 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010704b:	83 c3 10             	add    $0x10,%ebx
8010704e:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80107054:	75 d6                	jne    8010702c <setupkvm+0x2c>
}
80107056:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80107087:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
8010708a:	e8 71 ff ff ff       	call   80107000 <setupkvm>
8010708f:	a3 84 60 11 80       	mov    %eax,0x80116084
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80107094:	05 00 00 00 80       	add    $0x80000000,%eax
80107099:	0f 22 d8             	mov    %eax,%cr3
}
8010709c:	c9                   	leave  
8010709d:	c3                   	ret    
...
801070b2:	e8 99 f8 ff ff       	call   80106950 <walkpgdir>
  if(pte == 0)
801070b7:	85 c0                	test   %eax,%eax
801070b9:	74 05                	je     801070c0 <clearpteu+0x20>
    panic("clearpteu");
  *pte &= ~PTE_U;
801070bb:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801070be:	c9                   	leave  
801070bf:	c3                   	ret    
    panic("clearpteu");
801070c0:	83 ec 0c             	sub    $0xc,%esp
801070c3:	68 f2 7d 10 80       	push   $0x80107df2
...
801070da:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
801070dd:	e8 1e ff ff ff       	call   80107000 <setupkvm>
801070e2:	89 45 e0             	mov    %eax,-0x20(%ebp)
801070e5:	85 c0                	test   %eax,%eax
801070e7:	0f 84 9b 00 00 00    	je     80107188 <copyuvm+0xb8>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801070ed:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801070f0:	85 c9                	test   %ecx,%ecx
801070f2:	0f 84 90 00 00 00    	je     80107188 <copyuvm+0xb8>
801070f8:	31 f6                	xor    %esi,%esi
801070fa:	eb 46                	jmp    80107142 <copyuvm+0x72>
...
80107110:	e8 2b d7 ff ff       	call   80104840 <memmove>
...
8010712b:	e8 a0 f8 ff ff       	call   801069d0 <mappages>
...
80107149:	e8 02 f8 ff ff       	call   80106950 <walkpgdir>
...
80107156:	74 4e                	je     801071a6 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80107158:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
8010715a:	25 ff 0f 00 00       	and    $0xfff,%eax
8010715f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80107162:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107168:	e8 c3 b4 ff ff       	call   80102630 <kalloc>
...
80107179:	e8 02 fe ff ff       	call   80106f80 <freevm>
  return 0;
8010717e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
801071d2:	e8 79 f7 ff ff       	call   80106950 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
8010723e:	e8 fd d5 ff ff       	call   80104840 <memmove>
    len -= n;
    buf += n;
...
80107295:	b8 e4 a5 10 80       	mov    $0x8010a5e4,%eax
8010729a:	89 e5                	mov    %esp,%ebp
8010729c:	8b 55 08             	mov    0x8(%ebp),%edx
    /* setting initial seeds to mt[N] using         */
    /* the generator Line 25 of Table 1 in          */
    /* [KNUTH 1981, The Art of Computer Programming */
    /*    Vol. 2 (2nd Ed.), pp102]                  */
    mt[0]= seed & 0xffffffff;
8010729f:	89 15 e0 a5 10 80    	mov    %edx,0x8010a5e0
    for (mti=1; mti<N; mti++)
801072a5:	eb 0c                	jmp    801072b3 <sgenrand+0x23>
...
801072b9:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
801072bb:	3d 9c af 10 80       	cmp    $0x8010af9c,%eax
801072c0:	75 ee                	jne    801072b0 <sgenrand+0x20>
801072c2:	c7 05 60 a4 10 80 70 	movl   $0x270,0x8010a460
801072c9:	02 00 00 
}
801072cc:	5d                   	pop    %ebp
801072cd:	c3                   	ret    
...
801072d4:	a1 60 a4 10 80       	mov    0x8010a460,%eax
801072d9:	3d 6f 02 00 00       	cmp    $0x26f,%eax
801072de:	7f 3c                	jg     8010731c <genrand+0x4c>
801072e0:	8d 50 01             	lea    0x1(%eax),%edx
801072e3:	8b 04 85 e0 a5 10 80 	mov    -0x7fef5a20(,%eax,4),%eax
    ...
    y = mt[mti++];
801072ea:	89 15 60 a4 10 80    	mov    %edx,0x8010a460
    y ^= TEMPERING_SHIFT_U(y);
801072f0:	89 c2                	mov    %eax,%edx
801072f2:	c1 ea 0b             	shr    $0xb,%edx
801072f5:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
801072f7:	89 d0                	mov    %edx,%eax
801072f9:	c1 e0 07             	shl    $0x7,%eax
801072fc:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
80107301:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
80107303:	89 d0                	mov    %edx,%eax
80107305:	c1 e0 0f             	shl    $0xf,%eax
80107308:	25 00 00 c6 ef       	and    $0xefc60000,%eax
8010730d:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_L(y);
8010730f:	89 c2                	mov    %eax,%edx
80107311:	c1 ea 12             	shr    $0x12,%edx
80107314:	31 d0                	xor    %edx,%eax

    // Strip off uppermost bit because we want a long,
    // not an unsigned long
    return y & RAND_MAX;
80107316:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
8010731b:	c3                   	ret    
        if (mti == N+1)   /* if sgenrand() has not been called, */
8010731c:	3d 71 02 00 00       	cmp    $0x271,%eax
80107321:	0f 84 d2 00 00 00    	je     801073f9 <genrand+0x129>
    mt[0]= seed & 0xffffffff;
80107327:	31 c0                	xor    %eax,%eax
80107329:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80107330:	8b 0c 85 e0 a5 10 80 	mov    -0x7fef5a20(,%eax,4),%ecx
80107337:	83 c0 01             	add    $0x1,%eax
8010733a:	8b 14 85 e0 a5 10 80 	mov    -0x7fef5a20(,%eax,4),%edx
80107341:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
80107347:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
8010734d:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
8010734f:	89 d1                	mov    %edx,%ecx
80107351:	83 e2 01             	and    $0x1,%edx
80107354:	d1 e9                	shr    %ecx
80107356:	33 0c 85 10 ac 10 80 	xor    -0x7fef53f0(,%eax,4),%ecx
8010735d:	33 0c 95 54 7e 10 80 	xor    -0x7fef81ac(,%edx,4),%ecx
80107364:	89 0c 85 dc a5 10 80 	mov    %ecx,-0x7fef5a24(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
8010736b:	3d e3 00 00 00       	cmp    $0xe3,%eax
80107370:	75 be                	jne    80107330 <genrand+0x60>
80107372:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80107378:	8b 0c 85 e0 a5 10 80 	mov    -0x7fef5a20(,%eax,4),%ecx
8010737f:	83 c0 01             	add    $0x1,%eax
80107382:	8b 14 85 e0 a5 10 80 	mov    -0x7fef5a20(,%eax,4),%edx
80107389:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
8010738f:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
80107395:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
80107397:	89 d1                	mov    %edx,%ecx
80107399:	83 e2 01             	and    $0x1,%edx
8010739c:	d1 e9                	shr    %ecx
8010739e:	33 0c 85 50 a2 10 80 	xor    -0x7fef5db0(,%eax,4),%ecx
801073a5:	33 0c 95 54 7e 10 80 	xor    -0x7fef81ac(,%edx,4),%ecx
801073ac:	89 0c 85 dc a5 10 80 	mov    %ecx,-0x7fef5a24(,%eax,4)
        for (;kk<N-1;kk++) {
801073b3:	3d 6f 02 00 00       	cmp    $0x26f,%eax
801073b8:	75 be                	jne    80107378 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
801073ba:	a1 e0 a5 10 80       	mov    0x8010a5e0,%eax
801073bf:	8b 0d 9c af 10 80    	mov    0x8010af9c,%ecx
801073c5:	89 c2                	mov    %eax,%edx
801073c7:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
801073cd:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
801073d3:	09 d1                	or     %edx,%ecx
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
801073d5:	89 ca                	mov    %ecx,%edx
801073d7:	83 e1 01             	and    $0x1,%ecx
801073da:	d1 ea                	shr    %edx
801073dc:	33 15 10 ac 10 80    	xor    0x8010ac10,%edx
801073e2:	33 14 8d 54 7e 10 80 	xor    -0x7fef81ac(,%ecx,4),%edx
801073e9:	89 15 9c af 10 80    	mov    %edx,0x8010af9c
801073ef:	ba 01 00 00 00       	mov    $0x1,%edx
801073f4:	e9 f1 fe ff ff       	jmp    801072ea <genrand+0x1a>
    mt[0]= seed & 0xffffffff;
801073f9:	b8 e4 a5 10 80       	mov    $0x8010a5e4,%eax
801073fe:	b9 9c af 10 80       	mov    $0x8010af9c,%ecx
80107403:	ba 05 11 00 00       	mov    $0x1105,%edx
80107408:	c7 05 e0 a5 10 80 05 	movl   $0x1105,0x8010a5e0
8010740f:	11 00 00 
    for (mti=1; mti<N; mti++)
80107412:	eb 07                	jmp    8010741b <genrand+0x14b>
80107414:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107418:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
8010741b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
80107421:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
80107423:	39 c1                	cmp    %eax,%ecx
80107425:	75 f1                	jne    80107418 <genrand+0x148>
80107427:	e9 fb fe ff ff       	jmp    80107327 <genrand+0x57>
8010742c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80107430 <random_at_most>:
...
80107435:	31 d2                	xor    %edx,%edx
long random_at_most(long max) {
80107437:	89 e5                	mov    %esp,%ebp
...
8010743d:	53                   	push   %ebx
    bin_size = num_rand / num_bins,
8010743e:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    num_bins = (unsigned long) max + 1,
80107443:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
80107446:	89 d8                	mov    %ebx,%eax
80107448:	f7 f1                	div    %ecx
8010744a:	89 c6                	mov    %eax,%esi
8010744c:	29 d3                	sub    %edx,%ebx
8010744e:	66 90                	xchg   %ax,%ax
  ...
  do {
   x = genrand();
80107450:	e8 7b fe ff ff       	call   801072d0 <genrand>
  }
  // This is carefully written not to overflow
  while (num_rand - defect <= (unsigned long)x);
80107455:	39 d8                	cmp    %ebx,%eax
80107457:	73 f7                	jae    80107450 <random_at_most+0x20>

  // Truncated division is intentional
  return x/bin_size;
80107459:	31 d2                	xor    %edx,%edx
}
8010745b:	5b                   	pop    %ebx
  return x/bin_size;
8010745c:	f7 f6                	div    %esi
}
8010745e:	5e                   	pop    %esi
8010745f:	5d                   	pop    %ebp
80107460:	c3                   	ret    
