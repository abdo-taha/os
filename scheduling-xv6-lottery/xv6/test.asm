...
main(void)
{
  ...
  int x = settickets(2);
  17:	6a 02                	push   $0x2
  19:	e8 d5 03 00 00       	call   3f3 <settickets>
  printf(1,"%d\n",x);
  1e:	83 c4 0c             	add    $0xc,%esp
  21:	50                   	push   %eax
  22:	68 28 08 00 00       	push   $0x828
  27:	6a 01                	push   $0x1
  29:	e8 92 04 00 00       	call   4c0 <printf>
  x = settickets(0);
  2e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  35:	e8 b9 03 00 00       	call   3f3 <settickets>
  printf(1,"%d\n",x);
  ...
  x = settickets(5);
  4a:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  51:	e8 9d 03 00 00       	call   3f3 <settickets>
  printf(1,"%d\n",x);
  56:	83 c4 0c             	add    $0xc,%esp
  59:	50                   	push   %eax
  5a:	68 28 08 00 00       	push   $0x828
  5f:	6a 01                	push   $0x1
  61:	e8 5a 04 00 00       	call   4c0 <printf>
  x = settickets(-5);
  66:	c7 04 24 fb ff ff ff 	movl   $0xfffffffb,(%esp)
  6d:	e8 81 03 00 00       	call   3f3 <settickets>
  printf(1,"%d\n",x);
  72:	83 c4 0c             	add    $0xc,%esp
  75:	50                   	push   %eax
  76:	68 28 08 00 00       	push   $0x828
  7b:	6a 01                	push   $0x1
  7d:	e8 3e 04 00 00       	call   4c0 <printf>


  struct pstat *pst = malloc(sizeof(struct pstat));
  82:	c7 04 24 00 04 00 00 	movl   $0x400,(%esp)
  89:	e8 92 06 00 00       	call   720 <malloc>
  getpinfo(pst);
  8e:	89 04 24             	mov    %eax,(%esp)
  struct pstat *pst = malloc(sizeof(struct pstat));
  91:	89 c3                	mov    %eax,%ebx
  getpinfo(pst);
  93:	e8 63 03 00 00       	call   3fb <getpinfo>
  printf(1,"used \t pid  \t tickets \t ticks \n");
  98:	58                   	pop    %eax
  99:	5a                   	pop    %edx
  9a:	68 44 08 00 00       	push   $0x844
  9f:	6a 01                	push   $0x1
  a1:	8d 73 20             	lea    0x20(%ebx),%esi
  a4:	e8 17 04 00 00       	call   4c0 <printf>
  for(int i=0; i < 8 ; ++i){
  a9:	83 c4 10             	add    $0x10,%esp
  ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  printf (1,"%d \t %d \t %d \t\t %d \n " , pst->inuse[i] , pst->pid[i],pst->tickets[i],
  b0:	83 ec 08             	sub    $0x8,%esp
  b3:	ff b3 00 03 00 00    	pushl  0x300(%ebx)
  b9:	83 c3 04             	add    $0x4,%ebx
  bc:	ff b3 fc 00 00 00    	pushl  0xfc(%ebx)
  c2:	ff b3 fc 01 00 00    	pushl  0x1fc(%ebx)
  c8:	ff 73 fc             	pushl  -0x4(%ebx)
  cb:	68 2c 08 00 00       	push   $0x82c
  d0:	6a 01                	push   $0x1
  d2:	e8 e9 03 00 00       	call   4c0 <printf>
  for(int i=0; i < 8 ; ++i){
  d7:	83 c4 20             	add    $0x20,%esp
  da:	39 f3                	cmp    %esi,%ebx
  dc:	75 d2                	jne    b0 <main+0xb0>
    pst->ticks[i]);
  }  


  exit();
  de:	e8 70 02 00 00       	call   353 <exit>
  e3:	66 90                	xchg   %ax,%ax
  e5:	66 90                	xchg   %ax,%ax
  e7:	66 90                	xchg   %ax,%ax
  e9:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 64 08 00 00       	mov    $0x864,%ebx
        while(*s != 0){
